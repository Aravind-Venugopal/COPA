(function(g,u){var z={val:function(h){return this.val(h)},disabled:function(h){typeof h!=="undefined"&&this.filter("input").each(function(){var d=g(this);if(!h&&j(d))a(d);else h&&!j(d)&&m(d)});return this.is("input:disabled")}},x=null,y=null,v=function(h){h=g.extend({},g.fn.glowColorSelector.defaults,h||{});if(y===null){x=g.telligent.glow.utility;y=p(h)}return this.each(function(){var d=g(this);d.css({backgroundColor:d&&d.val()?x.convertRgbColorToHtmlColor(x.convertHtmlColorToRgbColor(d.val())):"",
textAlign:"center",color:x.getContrastingHtmlColorForRgbColor(x.convertHtmlColorToRgbColor(d&&d.val()?x.convertRgbColorToHtmlColor(x.convertHtmlColorToRgbColor(d.val())):""))});j(d)?m(d):a(d)})},p=function(h){var d={blendImageUrl:h.blendImageUrl,hueBlendImageUrl:h.hueBlendImageUrl,moveStartX:null,moveStartY:null,elementMoveStartX:null,elementMoveStartY:null};h=g("<div></div>").css({width:"290px",padding:"2px",paddingLeft:"6px",borderStyle:"solid",borderWidth:"1px",borderColor:"#000000",backgroundColor:"#eeeeee"});
...
clickValueSaturationHandler:function(l){x.getWindowInfo();var c=x.getElementInfo(d.selectBox);d.selectBoxCursor.css({left:l.pageX-c.Left+"px",top:l.pageY-c.Top+"px"});f.updateTemporaryValue();f.cursorMouseDownHandler(l)},updateTemporaryValue:function(l){var c=parseInt(d.selectBoxCursor.css("left"),10),b=(255-parseInt(d.selectBoxCursor.css("top"),10))/255,k=(255-parseInt(d.hueSelectCursor.css("top"),10))*(360/255),r=x.convertHsvColorToRgbColor([k,1,255]);d.selectBoxBackground.css({backgroundColor:x.convertRgbColorToHtmlColor(r)});
r=x.convertHsvColorToRgbColor([k,b,c]);c=x.convertRgbColorToHtmlColor(r);d.selectedColor.css({backgroundColor:c});l||d.selectedColor.val(c);d.selectedColor.css({color:x.getContrastingHtmlColorForRgbColor(r)})},parseEnteredColor:function(){var l=x.convertRgbColorToHsvColor(x.convertHtmlColorToRgbColor(d.selectedColor.val()));d.selectBoxCursor.css({left:l[2]+"px",top:l[1]*-255+255+"px"});d.hueSelectCursor.css({top:l[0]/-(360/255)+255+"px"});f.updateTemporaryValue(true)},showColorSelector:function(l){d.popupPanel.glowPopUpPanel("hide");
d.currentInput=l;d.popupPanel.glowPopUpPanel("show",d.currentInput);l=x.convertRgbColorToHsvColor(x.convertHtmlColorToRgbColor(d.currentInput.val()));d.selectBoxCursor.css({left:l[2]+"px",top:l[1]*-255+255+"px"});d.hueSelectCursor.css({top:l[0]/-(360/255)+255+"px"});d.selectedColor.val(d.currentInput.val());f.updateTemporaryValue(true);u.setTimeout(f.focusColorSelector,99)},focusColorSelector:function(){if(d.popupPanel.glowPopUpPanel("isOpening"))u.setTimeout(f.focusColorSelector,99);else try{d.selectedColor.focus().select()}catch(l){}},
selectTemporaryColor:function(){if(d.currentInput!==null){n(d.currentInput,d.selectedColor.val(),true);try{d.currentInput.focus()}catch(l){}d.popupPanel.glowPopUpPanel("hide")}},selectNoColor:function(){if(d.currentInput!==null){n(d.currentInput,"",true);try{d.currentInput.focus()}catch(l){}d.popupPanel.glowPopUpPanel("hide")}}};g.extend(d,f);return d},n=function(h,d,o){if(h){d=d?x.convertRgbColorToHtmlColor(x.convertHtmlColorToRgbColor(d)):"";var f=h.val()!=d;h.val(d).css({backgroundColor:h.val(),
color:x.getContrastingHtmlColorForRgbColor(x.convertHtmlColorToRgbColor(h.val()))});f&&o&&h.trigger("change")}},m=function(h){h.unbind("click.glowColorSelector").unbind("keydown.glowColorSelector").css({cursor:"default"}).attr("disabled","disabled")},a=function(h){h.bind("click.glowColorSelector",function(){h.blur();y.showColorSelector(h);return false}).bind("keydown.glowColorSelector",function(d){if(d.keyCode!=9&&d.keyCode!=16){h.blur();y.showColorSelector(h);return false}else return true}).css({cursor:"pointer"}).removeAttr("disabled")},
...
(function(g,u){var z={val:function(h){if(h===undefined){var d=g(this).data(x);if(d===null)return null;var o=d.internal.patternedTextBox.glowPatternedTextBox("getPatternValues"),f,l,c;if(d.settings.yearIndex>=0){f=parseInt(o[d.settings.yearIndex],10);if(isNaN(f))return null}else f=(new Date).getFullYear();if(d.settings.dayIndex>=0){c=parseInt(o[d.settings.dayIndex],10);if(isNaN(c))return null}else c=(new Date).getDate();if(d.settings.monthIndex>=0){l=n(d,o[d.settings.monthIndex])-1;if(isNaN(l))return null}else l=
(new Date).getMonth();h=new Date(f,l,c);if(d.settings.hourIndex>=0){f=parseInt(o[d.settings.hourIndex],10);if(isNaN(f))return null;else d.settings.amPmIndex>=0?h.setHours(m(d,f,o[d.settings.amPmIndex])):h.setHours(m(d,f,-1))}if(d.settings.minuteIndex>=0){d=parseInt(o[d.settings.minuteIndex],10);if(isNaN(d))return null;else h.setMinutes(d)}return h}else return this.each(function(){var b=g(this).data(x),k=b.internal.patternedTextBox.glowPatternedTextBox("getPatternValues");if(b.settings.yearIndex>=
0)k[b.settings.yearIndex]=h.getFullYear();if(b.settings.monthIndex>=0){var r=b.settings.monthIndex,e;e=h.getMonth()+1;var q=b.internal.patternedTextBox.glowPatternedTextBox("getPatternValueOption",b.settings.monthIndex,e-1);e=q?q:parseInt(e,10);k[r]=e}if(b.settings.dayIndex>=0)k[b.settings.dayIndex]=h.getDate();if(b.settings.hourIndex>=0){r=b.settings.hourIndex;e=h.getHours();k[r]=b.settings.amPmIndex>-1&&e>12?e-12:e}if(b.settings.minuteIndex>=0)k[b.settings.minuteIndex]=h.getMinutes();if(b.settings.amPmIndex>=
0){r=b.settings.amPmIndex;e=h.getHours();e=b.settings.amPmIndex>-1?e>=12?b.internal.patternedTextBox.glowPatternedTextBox("getPatternValueOption",b.settings.amPmIndex,1):b.internal.patternedTextBox.glowPatternedTextBox("getPatternValueOption",b.settings.amPmIndex,0):"";k[r]=e}b.internal.patternedTextBox.glowPatternedTextBox("setPatternValues",k)})},disabled:function(h){if(h===undefined){var d=this.data(x);if(d)return d.internal.patternedTextBox.glowPatternedTextBox("disabled");return false}else return this.each(function(){var o=
g(this).data(x);o.internal.patternedTextBox.glowPatternedTextBox("disabled",h);if(o.internal.popupButton)h?o.internal.popupButton.attr("disabled","disabled").unbind("click"+y):o.internal.popupButton.removeAttr("disabled").unbind("click"+y).bind("click"+y,function(){var f=z.val.apply(o.internal.state);f||(f=new Date);o.internal.currentDate=f;o.internal.currentMonth=f.getMonth()+1;o.internal.currentYear=f.getFullYear();a(o);o.internal.popupPanel.glowPopUpPanel("show",o.internal.popupButton)})})}},x=
"_glowDateTimeSelector",y=".glowDateTimeSelector",v=function(h){return this.each(function(){var d={settings:g.extend({},g.fn.glowDateTimeSelector.defaults,h||{}),internal:{state:g(this),initialized:false,patternedTextBox:null,popupButton:null,popupPanel:null,currentDate:new Date,currentYear:(new Date).getFullYear(),currentMonth:(new Date).getMonth()+1}};g(this).data(x,d);u.setTimeout(function(){p(d)},9)})},p=function(h){h.internal.patternedTextBox=h.internal.state.glowPatternedTextBox({pattern:h.settings.pattern,
...
y,function(q){if(h.settings.dayIndex>-1){h.internal.currentMonth--;if(h.internal.currentMonth<1){h.internal.currentMonth=12;h.internal.currentYear>0&&h.internal.currentYear--}}else h.internal.currentYear--;a(h);q.stopPropagation();return false}).appendTo(f);g("<div></div>").addClass(h.settings.previousButtonCssClass).html("&lt;").appendTo(l);l=g("<td></td>").css({textAlign:"center",padding:"2px",fontWeight:"bold",fontSize:"90%"}).appendTo(f);h.settings.dayIndex>-1?l.attr("colSpan",5).html(h.settings.monthNames[h.internal.currentMonth-
1]+" "+h.internal.currentYear):l.html(h.internal.currentYear);l=g("<td></td>").css({textAlign:"center",padding:"2px",cursor:"pointer"}).bind("click"+y,function(q){if(h.settings.dayIndex>-1){h.internal.currentMonth++;if(h.internal.currentMonth>12){h.internal.currentMonth=1;h.internal.currentYear<9999&&h.internal.currentYear++}}else h.internal.currentYear++;a(h);q.stopPropagation();return false}).appendTo(f);g("<div></div>").addClass(h.settings.nextButtonCssClass).html("&gt;").appendTo(l);o.append(f);
...
for(var b=0,k=5;b<c.getDay();){l=g("<td></td>").html("&nbsp;").css({fontSize:"90%",padding:"2px",textAlign:"center",width:"14%"}).appendTo(f);b++}var r=31;if(h.internal.currentMonth==2)r=!isNaN(h.internal.currentYear)&&h.internal.currentYear>-1&&(h.internal.currentYear%4===0&&h.internal.currentYear%100!==0||h.internal.currentYear%400===0)?29:28;else if(h.internal.currentMonth==4||h.internal.currentMonth==6||h.internal.currentMonth==9||h.internal.currentMonth==11)r=30;var e=-1;if(h.internal.currentMonth==
h.internal.currentDate.getMonth()+1&&h.internal.currentYear==h.internal.currentDate.getFullYear())e=h.internal.currentDate.getDate();for(c=1;c<=r;c++){b++;l=g("<td></td>").html(c).css({textAlign:"center",padding:"2px",fontSize:"90%",cursor:"pointer",width:"14%"}).bind("click"+y,g.telligent.glow.utility.makeBoundFunction(j,null,[h,c])).bind("mouseover"+y,function(q){g(q.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(h.internal.state,"background-color","backgroundColor","#fff"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(h.internal.state,
"color","color","#000")})}).bind("mouseout"+y,function(q){g(q.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(h.internal.state,"color","color","#000"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(h.internal.state,"background-color","backgroundColor","#fff")})});c==e&&l.css({padding:"1px",borderTopWidth:"1px",borderLeftWidth:"1px",borderRightWidth:"1px",borderBottomWidth:"1px",borderTopStyle:"solid",borderLeftStyle:"solid",borderRightStyle:"solid",borderBottomStyle:"solid",
...
cursor:"pointer",width:"14%"}).bind("click"+y,g.telligent.glow.utility.makeBoundFunction(j,null,[h,c])).bind("mouseover"+y,function(q){g(q.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(h.internal.state,"background-color","backgroundColor","#fff"),backgroundColor:g.telligent.glow.utility.getCurrentStyleValue(h.internal.state,"color","color","#000")})}).bind("mouseout"+y,function(q){g(q.target).css({color:g.telligent.glow.utility.getCurrentStyleValue(h.internal.state,"color","color",
...
window);
(function(g){var u=function(z){var x=z.data("_delayedEnterLeaveContextKey");if(x===null||typeof x==="undefined"){x={enterTimeout:null,leaveTimeout:null};z.data("_delayedEnterLeaveContextKey",x)}return x};g.extend(g.event.special,{glowDelayedMouseEnter:{add:function(z){var x=z.data||500;g(z.selector).live("mouseenter",function(){var y=g(this),v=u(y);v.enterTimeout=setTimeout(function(){y.trigger("glowDelayedMouseEnter");clearTimeout(v.enterTimeout)},x)}).live("mouseleave",function(){var y=u(g(this));
clearTimeout(y.enterTimeout)})}},glowDelayedMouseLeave:{add:function(z){var x=z.data||500;g(z.selector).live("mouseleave",function(){var y=g(this),v=u(y);v.leaveTimeout=setTimeout(function(){y.trigger("glowDelayedMouseLeave");clearTimeout(v.leaveTimeout)},x)}).live("mouseenter",function(){var y=u(g(this));clearTimeout(y.leaveTimeout)})}}})})(jQuery);
...
function(o,f){if(!j.initialized){var l=j.notSupportedMessage;if(!l){l=[];j.runtimes.indexOf("html5")>-1&&l.push("An HTML5 capable browser");j.runtimes.indexOf("silverlight")>-1&&l.push('<a href="http://microsoft.com/getsilverlight/" target="_blank">Silverlight</a>');j.runtimes.indexOf("flash")>-1&&l.push('<a href="http://get.adobe.com/flashplayer/" target="_blank">Flash</a>');if(l.length==0)l="Uploading is not supported.";else{if(l.length>1)l[l.length-1]="or "+l[l.length-1];l=l.join(", ")+" is required to upload."}}j.container.children().hide();
g("<div></div>").css({fontSize:"11px",borderWidth:"1px",borderStyle:"solid",borderColor:"#999",width:j.width,overflow:"auto",overflowX:"hidden",backgroundColor:"#eee",textAlign:"center",padding:".25em",color:"#000"}).html(l).appendTo(j.container)}if(f.file){j.isUploading=false;j.fileState="error";m(j);j.container.trigger(y.error)}});u.setTimeout(function(){j.pluploader.init()},9)},m=function(j){var h="";if(j.file)h=j.fileState==="uploaded"?j.uploadedFormat.replace("{0}",j.file.name):j.fileState===
"error"?j.errorFormat.replace("{0}",j.file.name):j.isUploading?j.uploadingFormat.replace("{0}",j.file.name).replace("{1}",j.currentUploadPercent):j.toUploadFormat.replace("{0}",j.file.name);j.fileContainer.html(h)},a=function(j){if(j.addedFiles){for(var h=[],d=0;d<j.pluploader.files.length;d++)for(var o=0;o<j.addedFiles.length;o++)if(j.pluploader.files[d].id==j.addedFiles[o].id){h[h.length]=j.addedFiles[o];break}j.addedFiles=null;if(h.length!==0){if(j.file){j.isUploading&&j.pluploader.stop();var f=
j.file.id;u.setTimeout(function(){if(j.pluploader&&f!="preuploaded")try{j.pluploader.removeFile(j.pluploader.getFile(f))}catch(l){}},99)}j.file=h[0];j.fileState="";m(j);j.file&&j.pluploader.start()}}};g.fn.glowUpload=function(j){if(j in z)return z[j].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof j==="object"||!j)return v.apply(this,arguments);else g.error("Method "+j+" does not exist on jQuery.fn.glowUpload")};g.extend(g.fn.glowUpload,{defaults:{fileFilter:null,maxFileSize:"2048mb",
width:"350px",uploadUrl:"/",swfUrl:"plupload.flash.swf",silverlightUrl:"",uploadedFormat:'<div style="overflow: hidden; text-overflow: ellipsis; color: #000; padding: .25em;"><div style="float: right; color: #3a3; margin-left: .25em;">Uploaded</div>{0}</div>',uploadingFormat:'<div style="overflow: hidden; text-overflow: ellipsis; color: #000; padding: .25em;"><div style="float: right; margin-top: .25em; margin-left: .25em; border: solid 1px #999; background-color: #eee; width: 50px; height: .5em;"><div style="background-color: #7e7; width: {1}%; height: .5em;"></div></div>{0}</div>',
toUploadFormat:'<div style="overflow: hidden; text-overflow: ellipsis; color: #666; font-style: italic; padding: .25em;">{0}</div>',errorFormat:'<div style="overflow: hidden; text-overflow: ellipsis; color: #000; padding: .25em;"><div style="float: right; color: #f00; margin-left: .25em;">Error</div>{0}</div>',runtimes:"html5,flash"}})})(jQuery,window);
(function(g){var u={disabled:function(e){if(e===undefined){var q=this.data("lookUpTextBox");if(q)return q.internal.state.readonly}else return this.each(function(){var t=g(this).data("lookUpTextBox");if(e){t.internal.cursor.style.visibility="hidden";t.internal.container.style.cursor="default";t.internal.container.onclick=null;t.internal.state.readonly=true;t.internal.emptyHtmlContainer.style.visibility="hidden"}else{t.internal.cursor.style.visibility="visible";t.internal.container.style.cursor="text";
t.internal.container.onclick=function(s){k(t,s)};t.internal.state.readonly=false;t.internal.emptyHtmlContainer.style.visibility="visible"}m(t)})},updateSuggestions:function(e){return this.each(function(){var q=g(this).data("lookUpTextBox");q.internal.lookUps=[];if(e)for(var t=0;t<e.length;t++)q.internal.lookUps[t]=e[t];q.internal.lookUpsIndex=-1;n(q)})},removeByIndex:function(e){return this.each(function(){var q=g(this).data("lookUpTextBox");if(e>=0&&e<q.internal.selectedLookUps.length){for(var t=
[],s=0;s<q.internal.selectedLookUps.length;s++)if(s!=e)t[t.length]=q.internal.selectedLookUps[s];q.internal.selectedLookUps=t;m(q);r(q)}})},removeByValue:function(e){return this.each(function(){for(var q=g(this).data("lookUpTextBox"),t=[],s=false,w=0;w<q.internal.selectedLookUps.length;w++)if(q.internal.selectedLookUps[w].Value!=e)t[t.length]=q.internal.selectedLookUps[w];else s=true;if(s){q.internal.selectedLookUps=t;m(q);r(q)}})},add:function(e){return this.each(function(){if(e!=null&&e.SelectedHtml){var q=
g(this).data("lookUpTextBox");q.internal.selectedLookUps[q.internal.selectedLookUps.length]=e;m(q);r(q)}})},getByIndex:function(e){var q=this.data("lookUpTextBox");if(q&&e>=0&&e<q.internal.selectedLookUps.length)return q.internal.selectedLookUps[e];return null},count:function(){var e=this.data("lookUpTextBox");return e?e.internal.selectedLookUps.length:0},getCurrentSearchText:function(){var e=this.data("lookUpTextBox");return e?e.internal.lastCursorValue:""},createLookUp:function(e,q,t,s){var w={};
w.Value=e;w.SelectedHtml=q;w.SuggestedHtml=t;w.Selectable=s;return w}},z=function(e){return this.each(function(){var q={settings:g.extend({},g.fn.glowLookUpTextBox.defaults,e||{}),internal:{state:this,cursorContainer:null,cursor:null,cursorText:null,lookUpsContainer:null,lookUpsIndex:null,lookUpsIndex:-1,popupPanel:null,lookUps:[],lastCursorValue:"",selectedLookUps:[],mouseIsOverPopup:false,emptyHtmlContainer:null,cursorHasFocus:false,cursorChangeHandler:null,height:18,backgroundColor:"#ffffff",lineHeight:"100%",
initialized:false}};g(this).data("lookUpTextBox",q);x(q)})},x=function(e){if(e.internal.state.offsetHeight){if(e.internal.state.disabled){e.internal.state.disabled=false;e.internal.state.readonly=true}e.internal.backgroundColor=g.telligent.glow.utility.getCurrentStyleValue(e.internal.state,"background-color","backgroundColor","#ffffff");if(e.internal.backgroundColor.replace(/\#[0-9a-f]*/gi,"")!="")e.internal.backgroundColor="#ffffff";e.internal.height=e.internal.state.offsetHeight-(parseInt(g.telligent.glow.utility.getCurrentStyleValue(e.internal.state,
...
e.internal.lineHeight;e.internal.cursor.style.color=g.telligent.glow.utility.getCurrentStyleValue(e.internal.state,"color","color","#000000");e.internal.cursor.style.borderWidth="0px";e.internal.cursor.style.padding="0px";e.internal.cursor.style.height=e.internal.height+"px";e.internal.cursor.style.width="100%";e.internal.cursor.onkeydown=function(w){return b(e,w)};e.internal.cursor.onkeyup=function(w){return f(e,w)};e.internal.cursor.onchange=function(w){return f(e,w)};e.internal.cursor.onpaste=
function(w){return f(e,w)};e.internal.cursor.onblur=function(w){return c(e,w)};e.internal.cursor.onclick=function(w){return k(e,w)};e.internal.cursor.onfocus=function(w){return l(e,w)};e.internal.cursor.tabIndex=e.internal.state.tabIndex;e.internal.cursorContainer.appendChild(e.internal.cursor);if(e.internal.state.id){var q=g('label[for="'+e.internal.state.id+'"]');if(q.length>0){e.internal.cursor.id=e.internal.state.id+"_"+(new Date).getTime();q.each(function(){g(this).attr("for",e.internal.cursor.id)})}}e.internal.container.appendChild(e.internal.cursorContainer);
q=document.createElement("div");q.style.clear="both";e.internal.container.appendChild(q);q=document.createElement("div");e.internal.container.appendChild(q);e.internal.popupPanel=g(q);e.internal.popupPanel.glowPopUpPanel({cssClass:"",position:"updown",zIndex:1E3,hideOnDocumentClick:true}).bind({glowPopUpPanelHidden:function(){e.internal.mouseIsOverPopup=false},glowPopUpPanelMouseOver:function(){e.internal.mouseIsOverPopup=true},glowPopUpPanelMouseOut:function(){e.internal.mouseIsOverPopup=false}});
e.internal.popupPanel.glowPopUpPanel("empty");e.internal.lookUpsContainer=document.createElement("div");e.internal.lookUpsContainer.style.borderStyle="outset";e.internal.lookUpsContainer.style.borderWidth="1px";e.internal.lookUpsContainer.style.borderColor="#999999";e.internal.lookUpsContainer.style.height=g.telligent.glow.utility.getWindowInfo().Height/4+24+"px";e.internal.lookUpsContainer.style.width=e.internal.state.offsetWidth-4+"px";e.internal.lookUpsContainer.style.overflow="auto";e.internal.lookUpsContainer.style.overflowX=
"hidden";e.internal.lookUpsContainer.style.padding="1px";e.internal.lookUpsContainer.style.backgroundColor=e.internal.backgroundColor;e.internal.lookUpsContainer.style.fontFamily=g.telligent.glow.utility.getCurrentStyleValue(e.internal.state,"font-family","fontFamily","Arial, Helvetica");e.internal.lookUpsContainer.style.fontSize=g.telligent.glow.utility.getCurrentStyleValue(e.internal.state,"font-size","fontSize","100%");e.internal.lookUpsContainer.style.lineHeight=g.telligent.glow.utility.getCurrentStyleValue(e.internal.state,
"line-height","lineHeight","100%");e.internal.lookUpsContainer.style.color=g.telligent.glow.utility.getCurrentStyleValue(e.internal.state,"color","color","#000000");e.internal.popupPanel.glowPopUpPanel("append",e.internal.lookUpsContainer);try{e.internal.state.type="hidden"}catch(t){}e.internal.state.style.display="none";q=e.internal.state.value.split(e.settings.delimiter);if(q.length==e.settings.selectedLookUpsHtml.length){e.internal.selectedLookUps=[];for(var s=0;s<q.length;s++)e.internal.selectedLookUps[e.internal.selectedLookUps.length]=
u.createLookUp(q[s],e.settings.selectedLookUpsHtml[s],e.settings.selectedLookUpsHtml[s],true)}e.internal.initialized=true;n(e);u.disabled.apply(g(e.internal.state),[e.internal.state.readonly===true])}else window.setTimeout(function(){x(e)},249)},y=function(e){e.internal.lookUpsContainer.style.overflow="hidden";e.internal.lookUpsContainer.style.height="200px";e.internal.popupPanel.glowPopUpPanel("show",e.internal.container,e.internal.popupPanel.glowPopUpPanel("isShown"));window.setTimeout(function(){p(e)},
49)},v=function(e){e.internal.popupPanel&&e.internal.popupPanel.glowPopUpPanel("isShown")&&e.internal.popupPanel.glowPopUpPanel("hide")},p=function(e){if(e.internal.popupPanel.glowPopUpPanel("isOpening"))window.setTimeout(function(){p(e)},49);else{try{e.internal.lookUpsContainer.style.overflow="auto";e.internal.lookUpsContainer.style.overflowX="hidden"}catch(q){}e.internal.state.selectedIndex>=0&&_highlightItem(e,e.internal.state.selectedIndex)}},n=function(e){if(e&&e.internal.initialized){for(;e.internal.lookUpsContainer.childNodes.length>
0;)e.internal.lookUpsContainer.removeChild(e.internal.lookUpsContainer.childNodes[0]);if(e.internal.lookUps.length>0){for(var q=e.internal.lookUpsIndex,t=0;t<e.internal.lookUps.length;t++){var s=document.createElement("div");s.onmouseover=g.telligent.glow.utility.makeBoundFunction(h,null,[e,t]);s.onclick=g.telligent.glow.utility.makeBoundFunction(d,null,[e,t]);s.style.padding="2px";s.style.cursor="pointer";s.style.borderStyle="dotted";s.style.borderWidth="1px";s.style.borderColor=e.internal.backgroundColor;
s.innerHTML=e.internal.lookUps[t].SuggestedHtml;e.internal.lookUpsContainer.appendChild(s)}if(q<0||q>=e.internal.lookUps.length)q=0;h(e,q);y(e)}else v(e)}},m=function(e){for(;e.internal.container.childNodes.length>3;)e.internal.container.removeChild(e.internal.container.childNodes[0]);for(var q=0;q<e.internal.selectedLookUps.length;q++){var t=document.createElement("div");t.style.padding="2px";if(e.settings.maxValues!=1){t.style.cssFloat="left";t.style.styleFloat="left"}var s=document.createElement("div");
s.style.borderStyle="solid";s.style.borderColor="#bbbbbb";s.style.backgroundColor="#eeeeee";s.style.borderWidth="1px";s.style.padding="2px";s.style.paddingRight="6px";if(u.disabled.apply(g(e.internal.state)))s.style.paddingLeft="6px";s.style.height=e.internal.height+"px";s.style.lineHeight=e.internal.lineHeight;s.style.whiteSpace="nowrap";s.style.cursor="default";s.style.fontFamily=e.internal.cursor.style.fontFamily;s.style.fontSize=e.internal.cursor.style.fontSize;if(!u.disabled.apply(g(e.internal.state)))if(e.settings.deleteImageUrl){var w=
document.createElement("img");w.src=e.settings.deleteImageUrl;w.align="top";w.style.padding="4px";w.style.paddingRight="6px";w.style.cursor="pointer";w.onclick=g.telligent.glow.utility.makeBoundFunction(a,null,[e,q]);s.appendChild(w)}else{w=document.createElement("a");w.href="#";w.onclick=g.telligent.glow.utility.makeBoundFunction(a,null,[e,q]);w.style.textDecoration="none";w.style.color="#f00";w.style.fontWeight="bold";w.style.fontSize="80%";w.style.lineHeight=e.internal.lineHeight;w.style.marginLeft=
"4px";w.style.marginRight="6px";w.innerHTML="X";s.appendChild(w)}w=document.createElement("span");w.innerHTML=e.internal.selectedLookUps[q].SelectedHtml;w.style.cursor="default";s.appendChild(w);t.appendChild(s);e.internal.container.insertBefore(t,e.internal.cursorContainer)}if(e.settings.maxValues>0&&e.settings.maxValues==e.internal.selectedLookUps.length){e.internal.container.childNodes[e.internal.container.childNodes.length-2].style.display="none";e.internal.container.childNodes[e.internal.container.childNodes.length-
3].style.display="none"}else{e.internal.container.childNodes[e.internal.container.childNodes.length-2].style.display="inline";e.internal.container.childNodes[e.internal.container.childNodes.length-3].style.display="inline"}},a=function(e,q){u.removeByIndex.apply(g(e.internal.state),[q]);g(e.internal.state).trigger("glowLookUpTextBoxChange");return false},j=function(e,q){if(e.internal.lookUps[q]&&e.internal.lookUps[q].Selectable){if(!e.settings.allowDuplicates)for(var t=0;t<e.internal.selectedLookUps.length;t++)if(e.internal.selectedLookUps[t].Value==
e.internal.lookUps[q].Value)return;e.internal.selectedLookUps[e.internal.selectedLookUps.length]=u.createLookUp(e.internal.lookUps[q].Value,e.internal.lookUps[q].SelectedHtml);e.internal.cursor.value="";v(e);m(e);r(e);try{e.internal.cursor.focus()}catch(s){}g(e.internal.state).trigger("glowLookUpTextBoxChange")}},h=function(e,q){if(e.internal.lookUps[q]&&e.internal.lookUps[q].Selectable){var t=e.internal.lookUpsContainer.childNodes[q];t.style.backgroundColor="#cccccc";t.style.borderColor="#666666";
if(t.offsetTop+t.offsetHeight>e.internal.lookUpsContainer.scrollTop+e.internal.lookUpsContainer.offsetHeight)e.internal.lookUpsContainer.scrollTop=t.offsetTop+t.offsetHeight-e.internal.lookUpsContainer.offsetHeight;else if(t.offsetTop<e.internal.lookUpsContainer.scrollTop)e.internal.lookUpsContainer.scrollTop=t.offsetTop;if(e.internal.lookUpsIndex>=0&&e.internal.lookUpsIndex!=q){t=e.internal.lookUpsContainer.childNodes[e.internal.lookUpsIndex];t.style.backgroundColor=e.internal.backgroundColor;t.style.borderColor=
e.internal.backgroundColor}e.internal.lookUpsIndex=q}},d=function(e,q){j(e,q);return false},o=function(e){if(e.internal.lastCursorValue!=e.internal.cursor.value&&e.internal.cursor.value.length>0)f(e);else e.internal.cursorChangeHandler=window.setTimeout(function(){o(e)},149)},f=function(e,q){if(!q)q=window.event;if(e.internal.lastCursorValue!=e.internal.cursor.value){e.internal.cursorChangeHandler&&window.clearTimeout(e.internal.cursorChangeHandler);if(e.settings.maxValues>0&&e.internal.selectedLookUps.length>=
e.settings.maxValues){window.setTimeout(function(){e.internal.cursor.value=""},19);return false}e.internal.lastCursorValue=e.internal.cursor.value;if(e.internal.lastCursorValue!="")e.settings.onGetLookUps&&e.settings.onGetLookUps(g(e.internal.state),e.internal.lastCursorValue);else v(e)}return true},l=function(e){e.internal.emptyHtmlContainer.style.display="none";e.internal.cursorHasFocus=true;e.internal.cursorChangeHandler=window.setTimeout(function(){o(e)},149)},c=function(e){e.internal.cursorChangeHandler&&
clearTimeout(e.internal.cursorChangeHandler);e.internal.cursorHasFocus=false;window.setTimeout(function(){e.internal.cursor.value="";e.internal.lastCursorValue="";e.internal.mouseIsOverPopup||v(e);if(e.internal.selectedLookUps.length==0&&!e.internal.cursorHasFocus)e.internal.emptyHtmlContainer.style.display="block"},99)},b=function(e,q){if(!q)q=window.event;if(q.keyCode==8){if(e.internal.selectedLookUps.length>0&&g.telligent.glow.utility.getCurrentCursorIndex(e.internal.cursor)==0){u.removeByIndex.apply(g(e.internal.state),
[e.internal.selectedLookUps.length-1]);g(e.internal.state).trigger("glowLookUpTextBoxChange")}return true}else if(q.keyCode==38||q.keyCode==40||q.keyCode==13){if(q.keyCode==38)e.internal.popupPanel.glowPopUpPanel("isShown")&&e.internal.lookUpsIndex>0&&h(e,e.internal.lookUpsIndex-1);else if(q.keyCode==40)e.internal.popupPanel.glowPopUpPanel("isShown")&&e.internal.lookUpsIndex<e.internal.lookUps.length-1&&h(e,e.internal.lookUpsIndex+1);else if(q.keyCode==13)if(e.internal.popupPanel.glowPopUpPanel("isShown")&&
e.internal.lookUpsIndex>=0)j(e,e.internal.lookUpsIndex);else{e.internal.cursor.value="";e.internal.lastCursorValue=""}q.cancelBubble=true;q.preventDefault&&q.preventDefault();q.stopProgagation&&q.stopPropagation();return false}else if(q.keyCode==9)if(e.internal.popupPanel.glowPopUpPanel("isShown")&&e.internal.lookUpsIndex>=0)j(e,e.internal.lookUpsIndex);else{e.internal.cursor.value="";e.internal.lastCursorValue=""}else if(e.settings.maxValues>0&&e.internal.selectedLookUps.length>=e.settings.maxValues){q.cancelBubble=
true;q.preventDefault&&q.preventDefault();q.stopProgagation&&q.stopPropagation();return false}return true},k=function(e){e.internal.emptyHtmlContainer.style.display="none";try{e.internal.cursor.focus()}catch(q){}return false},r=function(e){for(var q=[],t=0;t<e.internal.selectedLookUps.length;t++)q[q.length]=e.internal.selectedLookUps[t].Value;e.internal.state.value=q.join(e.settings.delimiter)};g.fn.glowLookUpTextBox=function(e){if(e in u)return u[e].apply(this,Array.prototype.slice.call(arguments,
1));else if(typeof e==="object"||!e)return z.apply(this,arguments);else g.error("Method "+e+" does not exist on jQuery.fn.glowLookUpTextBox")};g.extend(g.fn.glowLookUptextBox,{defaults:{delimiter:",",allowDuplicates:false,maxValues:0,onGetLookUps:null,emptyHtml:"",selectedLookUpsHtml:[],deleteImageUrl:""}})})(jQuery);
(function(g,u){var z=function(m,a){var j={};j=m&&g.isPlainObject(m)?g.extend({},g.glowModal.defaults,m||{}):g.extend({},g.glowModal.defaults,a||{},{url:m});if(!j.openerWindow)j.openerWindow=u;var h=v(j.openerWindow);if(h)h.$.glowModal(j);else{h=null;for(var d=0;d<x.length;d++)if(!x[d].shown()){h=x[d];break}if(!h){x[x.length]=new n("telligent_modal_"+x.length);h=x[x.length-1]}h.open(j)}};g.extend(z,{defaults:{width:300,height:300,onClose:null,x:null,y:null,ignoreCloseAndAnimation:null,isManuallyresized:null,
loadingHtmlUrl:"",windowCssClasses:[],windowTitleCssClasses:[],windowCloseCssClasses:[],windowContentCssClasses:[],windowMaskCssClasses:[],windowFooterCssClasses:[],windowResizeCssClasses:[],zIndex:1E3,enableAnimation:false,enableAutoResizing:true,openInParentModal:true,url:null,html:null,title:null},close:function(m,a){a||(a=u);var j=v(a);if(j)j.$.glowModal.close(m,a);else(j=p(a))&&j.close(m)},moveTo:function(m,a,j){j||(j=u);var h=v(j);if(h)h.$.glowModal.moveTo(m,a,j);else(j=p(j))&&j.moveTo(m,a)},
resize:function(m,a,j,h){h||(h=u);var d=v(h);if(d)d.$.glowModal.resize(m,a,j,h);else(h=p(h))&&h.resize(m,a,j)},refresh:function(m){m||(m=u);var a=v(m);a?a.$.glowModal.refresh(m):g.each(x,function(j,h){h.refresh()})},opener:function(m,a){a||(a=u);var j=v(a);if(j)return j.$.glowModal.getWindowopener(m,a);j=y(x,function(h){return h.shown()&&h._modalIframe.contentWindow==m});return j!==null?j._openerWindow:null},visible:function(m){m||(m=u);var a=v(m);if(a)return a.$.glowModal.shown(m);return(m=p(m))?
m.shown():false}});g.extend({glowModal:z});var x=[],y=function(m,a){var j=g.grep(m,a);return j!==null&&j.length>0?j[0]:null},v=function(){if(z.defaults.openInParentModal)try{if(u.parent&&u.parent!=u&&parent.$&&parent.$.glowModal)return u.parent}catch(m){}return null},p=function(m){return y(x,function(a){return a.shown()&&a._openerWindow==m})},n=function(m){this._id=m;this._initialized=this._isShown=false;this._animationHandle=this._modalContent=this._modalFooter=this._modalResize=this._modalIframe=
this._modalMask=this._modalAnimationMask=this._modalClose=this._modalTitle=this._modal=null;this._isOpening=false;this._lastWindowInfo=this._lastModalInfo=this._checkForScrollresizeHandle=null;this._isDragging=false;this._resizeModalInfo=this._moveModalInfo=null;this._isResizing=false};g.extend(n.prototype,{_animate:function(m,a,j,h){this._animationHandle&&u.clearTimeout(this._animationHandle);if(this._isOpening){var d=parseInt(this._modal.style.top,10);if(j<0&&d<m||j>0&&d>m||Math.abs(j)<1){this._modal.style.top=
m+"px";this._modalAnimationMask.style.overflow="visible";this._animationHandle=null;if(!this._isResizing&&!this._isDragging&&this._settings.url)this._modalIframe.style.visibility="visible";this._isOpening=false;this._lastWindowInfo=g.telligent.glow.utility.getWindowInfo();var o=this;this._checkForScrollresizeHandle=u.setTimeout(function(){o._checkForScrollresize()},249)}else{this._modal.style.top=a+"px";a+=j;if(j>0&&a>m)a=m;else if(j<0&&a<m)a=m;j*=h;o=this;this._animationHandle=u.setTimeout(function(){o._animate(m,
a,j,h)},19)}}},_startDrag:function(m){this._initialized||this._initialize();if(!m)m=u.event;this._moveModalInfo={};this._moveModalInfo.StartMouseX=m.pageX?m.pageX:m.screenX;this._moveModalInfo.StartMouseY=m.pageY?m.pageY:m.screenY;this._moveModalInfo.StartModalX=this._lastModalInfo.X;this._moveModalInfo.StartModalY=this._lastModalInfo.Y;this._moveModalInfo.Button=m.button;var a=this;g(document).bind("mouseup.glowModal",function(j){a._endDrag(j);return false}).bind("mousemove.glowModal",function(j){a._drag(j);
return false});this._isDragging=true;if(this._modalIframe)this._modalIframe.style.visibility="hidden"},_endDrag:function(){this._initialized||this._initialize();g(document).unbind("mouseup.glowModal").unbind("mousemove.glowModal");if(this._settings.url)this._modalIframe.style.visibility="visible";this._isDragging=false;this._moveModalInfo=null},_drag:function(m){this._initialized||this._initialize();if(!m)m=u.event;m.button!=this._moveModalInfo.Button?this._endDrag(m):this.moveTo(this._moveModalInfo.StartModalX+
((typeof m.pageX!="undefined"?m.pageX:m.screenX)-this._moveModalInfo.StartMouseX),this._moveModalInfo.StartModalY+((typeof m.pageY!="undefined"?m.pageY:m.screenY)-this._moveModalInfo.StartMouseY))},_startresize:function(m){this._initialized||this._initialize();if(!m)m=u.event;this._resizeModalInfo={};this._resizeModalInfo.StartMouseX=m.pageX?m.pageX:m.screenX;this._resizeModalInfo.StartMouseY=m.pageY?m.pageY:m.screenY;this._resizeModalInfo.StartModalWidth=this._lastModalInfo.Width;this._resizeModalInfo.StartModalHeight=
this._lastModalInfo.Height;this._resizeModalInfo.Button=m.button;var a=this;g(document).bind("mouseup.glowModal",function(j){a._endresize(j);return false}).bind("mousemove.glowModal",function(j){a._resize(j);return false});if(this._modalIframe)this._modalIframe.style.visibility="hidden";this._isResizing=true},_endresize:function(){this._initialized||this._initialize();this._isResizing=false;this._resizeModalInfo=null;g(document).unbind("mouseup.glowModal").unbind("mousemove.glowModal");if(this._settings.url)this._modalIframe.style.visibility=
"visible"},_resize:function(m){this._initialized||this._initialize();if(!m)m=u.event;m.button!=this._resizeModalInfo.Button?this._endresize(m):this.resize(this._resizeModalInfo.StartModalWidth+((typeof m.pageX!="undefined"?m.pageX:m.screenX)-this._resizeModalInfo.StartMouseX),this._resizeModalInfo.StartModalHeight+((typeof m.pageY!="undefined"?m.pageY:m.screenY)-this._resizeModalInfo.StartMouseY),true)},_checkForScrollresize:function(){this._checkForScrollresizeHandle&&u.clearTimeout(this._checkForScrollresizeHandle);
if(this._isShown&&!this._isOpening&&this._lastWindowInfo){if(this._settings.title)g(this._modalTitle.childNodes[1]).html(this._settings.title);else if(this._settings.url)try{if(document.all)this._modalTitle.childNodes[1].innerText=this._modalIframe.contentWindow.document.title;else this._modalTitle.childNodes[1].textContent=this._modalIframe.contentWindow.document.title}catch(m){}var a=g.telligent.glow.utility.getWindowInfo();if(a.ScrollX!=this._lastWindowInfo.ScrollX||a.ScrollY!=this._lastWindowInfo.ScrollY||
a.Width!=this._lastWindowInfo.Width||a.Height!=this._lastWindowInfo.Height)this.resize(this._lastModalInfo.Width,this._lastModalInfo.Height,false);else{if(this._settings.enableAutoResizing&&!this._isDragging&&!this._isResizing)try{if(this._settings.url){var j=this._modalIframe.contentWindow.document;if(!j.readyState||j.readyState=="complete"){var h=g.telligent.glow.utility.getWindowInfo(this._modalIframe.contentWindow),d=h.ContentHeight,o=h.ContentWidth,f=g.telligent.glow.utility.getStyleOffset(this._modalContent),
l=this._modal.offsetHeight-this._modalContent.offsetHeight-f.Height,c=this._modal.offsetWidth-this._modalContent.offsetWidth-f.Width;if(d>a.Height-l)d=a.Height-l;if(o>a.Width-c)o=a.Width-c;var b=d!=this._lastModalInfo.Height&&(d>this._lastModalInfo.Height||this._lastModalInfo.Height-d>64&&d>32)&&(!this._lastModalInfo.IsManuallyresized||d>this._lastModalInfo.Height),k=o!=this._lastModalInfo.Width&&(o>this._lastModalInfo.Width||this._lastModalInfo.Width-o>64&&o>32)&&(!this._lastModalInfo.IsManuallyresized||
o>this._lastModalInfo.Width);if(b||k){this.resize(k?o:this._lastModalInfo.Width,b?d:this._lastModalInfo.Height,false);return}}}}catch(r){}var e=this;this._checkForScrollresizeHandle=u.setTimeout(function(){e._checkForScrollresize()},249)}}},_initialize:function(){this._modalMask=document.createElement("div");this._modalMask.style.height="0";this._modalMask.style.position="absolute";this._modalMask.style.visibility="hidden";this._modalMask.style.overflow="hidden";var m=this._modalMask;if(this._settings.windowMaskCssClasses.length>
0){m.className=this._settings.windowMaskCssClasses[0];for(var a=1;a<this._settings.windowMaskCssClasses.length;a++){m.appendChild(document.createElement("div"));m=m.childNodes[0];m.className=this._settings.windowMaskCssClasses[a];m.style.width="auto";m.style.height="auto"}}document.body.appendChild(this._modalMask);this._modalAnimationMask=document.createElement("div");this._modalAnimationMask.style.position="absolute";this._modalAnimationMask.style.visibility="hidden";this._modalAnimationMask.style.overflow=
"hidden";this._modalAnimationMask.style.height="0";this._modal=document.createElement("div");this._modal.style.width="auto";this._modal.style.height="auto";this._modal.style.position="absolute";this._modal.style.visibility="hidden";m=this._modal;if(this._settings.windowCssClasses.length>0){m.className=this._settings.windowCssClasses[0];for(a=1;a<this._settings.windowCssClasses.length;a++){m.appendChild(document.createElement("div"));m=m.childNodes[0];m.className=this._settings.windowCssClasses[a];
m.style.width="auto";m.style.height="auto"}}this._modalTitle=document.createElement("div");m.appendChild(this._modalTitle);if(this._settings.windowTitleCssClasses.length>0){this._modalTitle.className=this._settings.windowTitleCssClasses[0];for(a=1;a<this._settings.windowTitleCssClasses.length;a++){this._modalTitle.appendChild(document.createElement("div"));this._modalTitle=this._modalTitle.childNodes[0];this._modalTitle.className=this._settings.windowTitleCssClasses[a]}}var j=this;g(this._modalTitle).bind("mousedown.glowModal",
...
return false});this._modalTitle.appendChild(document.createElement("span"));a=document.createElement("div");a.style.clear="both";this._modalTitle.appendChild(a);this._modalContent=document.createElement("div");m.appendChild(this._modalContent);if(this._settings.windowContentCssClasses.length>0){this._modalContent.className=this._settings.windowContentCssClasses[0];for(a=1;a<this._settings.windowContentCssClasses.length;a++){this._modalContent.appendChild(document.createElement("div"));this._modalContent=
this._modalContent.childNodes[0];this._modalContent.className=this._settings.windowContentCssClasses[a]}}if(this._settings.url){this._modalIframe=document.createElement("iframe");this._modalIframe.src=this._settings.loadingHtmlUrl;this._modalIframe.width="100%";this._modalIframe.border="0";this._modalIframe.frameBorder="0";this._modalIframe.style.borderLeftWidth="0px";this._modalIframe.style.borderRightWidth="0px";this._modalIframe.style.borderTopWidth="0px";this._modalIframe.style.borderBottomWidth=
"0px";this._modalIframe.id=this._id+"_iframe";this._modalContent.appendChild(this._modalIframe)}else this._settings.html&&g(this._modalContent).html(this._settings.html);this._modalFooter=document.createElement("div");m.appendChild(this._modalFooter);m=this._modalFooter;if(this._settings.windowFooterCssClasses.length>0){m.className=this._settings.windowFooterCssClasses[0];for(a=1;a<this._settings.windowFooterCssClasses.length;a++){m.appendChild(document.createElement("div"));m=m.childNodes[0];m.className=
...
g(this._modalResize).bind("mousedown.glowModal",function(d){j._startresize(d);return false});this._modalAnimationMask.appendChild(this._modal);document.body.appendChild(this._modalAnimationMask);this._initialized=true},shown:function(){return this._isShown},resize:function(m,a,j){if(this._isShown&&!this._isOpening&&this._lastModalInfo)this.open({url:this._settings.url,html:this._settings.html,title:this._settings.title,width:m,height:a,onClose:this._lastModalInfo.onClose,x:this._lastModalInfo.X,y:this._lastModalInfo.Y,
ignorecloseAndAnimation:true,isManuallyresized:j?true:this._lastModalInfo.IsManuallyresized})},moveTo:function(m,a){this._isShown&&!this._isOpening&&this._lastModalInfo&&this.open({url:this._settings.url,html:this._settings.html,title:this._settings.title,width:this._lastModalInfo.Width,height:this._lastModalInfo.Height,onClose:this._lastModalInfo.onClose,x:m,y:a,ignorecloseAndAnimation:true,isManuallyresized:this._lastModalInfo.IsManuallyresized})},open:function(m){this._settings=g.extend({},g.glowModal.defaults,
m);m=this._settings.onClose;var a=this._settings.x,j=this._settings.y,h=this._settings.ignorecloseAndAnimation,d=this._settings.isManuallyresized,o=this._settings.openerWindow;if(o)this._openerWindow=o;!h&&this._isShown&&this.close();this._initialized||this._initialize();if(this._settings.title)g(this._modalTitle.childNodes[1]).html(this._settings.title);else if(this._settings.url){try{if(document.all)this._modalTitle.childNodes[1].innerText=this._modalIframe.contentWindow.document.title;else this._modalTitle.childNodes[1].textContent=
this._modalIframe.contentWindow.document.title}catch(f){}if(!h&&this._settings.url)this._modalIframe.src=this._settings.url;try{if(this._settings.url)this._modalIframe.contentWindow.opener=u}catch(l){}}this._lastWindowInfo=g.telligent.glow.utility.getWindowInfo();if(!h){this._modalAnimationMask.style.position="absolute";this._modalAnimationMask.style.zIndex=this._settings.zIndex;this._modalAnimationMask.style.visibility="hidden";this._modalAnimationMask.style.height="auto";this._modalAnimationMask.style.overflow=
"hidden";this._modal.style.position="absolute";this._modal.style.visibility="hidden";this._modal.style.left="0px";this._modal.style.top="0px";this._modalMask.style.position="absolute";this._modalMask.style.visibility="visible";this._modalMask.style.zIndex=this._settings.zIndex;this._modalMask.style.height="auto"}var c=g.telligent.glow.utility.getStyleOffset(this._modalContent);o=this._modal.offsetWidth-this._modalContent.offsetWidth-c.Width;c=this._modal.offsetHeight-this._modalContent.offsetHeight-
c.Height;if(this._settings.width+o>this._lastWindowInfo.Width)this._settings.width=this._lastWindowInfo.Width-o;this._modalAnimationMask.style.width=this._settings.width+"px";this._modalContent.style.width=this._settings.width+"px";if(this._settings.height+c>this._lastWindowInfo.Height)this._settings.height=this._lastWindowInfo.Height-c;if(this._settings.width<this._modalResize.offsetWidth*2)this._settings.width=this._modalResize.offsetWidth*2;if(this._settings.width<this._modalClose.offsetWidth*
2)this._settings.width=this._modalClose.offsetWidth*2;if(this._settings.height<this._modalTitle.offsetHeight+this._modalFooter.offsetHeight)this._settings.height=this._modalTitle.offsetHeight+this._modalFooter.offsetHeight-c;if(this._settings.url){this._modalIframe.style.height=this._settings.height+"px";this._modalIframe.style.width=this._settings.width+"px"}this._modalContent.style.height=this._settings.height+"px";this._modalContent.style.width=this._settings.width+"px";this._modalAnimationMask.style.width=
this._modal.offsetWidth+"px";this._modalAnimationMask.style.height=this._modal.offsetHeight+"px";this._modalMask.style.left="0px";this._modalMask.style.top="0px";this._modalMask.style.width=this._lastWindowInfo.ContentWidth+"px";this._modalMask.style.height=this._lastWindowInfo.ContentHeight+"px";this._lastWindowInfo=g.telligent.glow.utility.getWindowInfo();o=this._modal.offsetWidth;c=this._modal.offsetHeight;if(typeof a=="undefined"||isNaN(parseInt(a,10)))a=(this._lastWindowInfo.Width-o)/2+this._lastWindowInfo.ScrollX;
if(a+o>this._lastWindowInfo.Width+this._lastWindowInfo.ScrollX)a=this._lastWindowInfo.Width+this._lastWindowInfo.ScrollX-o;if(a<this._lastWindowInfo.ScrollX)a=this._lastWindowInfo.ScrollX;if(typeof j=="undefined"||isNaN(parseInt(j,10)))j=(this._lastWindowInfo.Height-c)/2+this._lastWindowInfo.ScrollY;if(j+c>this._lastWindowInfo.Height+this._lastWindowInfo.ScrollY)j=this._lastWindowInfo.Height+this._lastWindowInfo.ScrollY-c;if(j<this._lastWindowInfo.ScrollY)j=this._lastWindowInfo.ScrollY;this._modalAnimationMask.style.left=
a+"px";this._modalAnimationMask.style.top=j+"px";this._modalAnimationMask.style.overflow="hidden";if(!h){this._modal.style.visibility="visible";this._modalAnimationMask.style.visibility="visible";g.telligent.glow.utility.hideSelectBoxes(this._modalAnimationMask,true)}this._isOpening=true;if(!this.EnableAnimation||h)this._animate(0,0,0,0);else{if(this._settings.url)this._modalIframe.style.visibility="hidden";this._animate(0,-c,c/3,0.67)}this._lastModalInfo={Url:this._settings.url?this._modalIframe.src:
null,onClose:m,X:a,Y:j,Width:parseInt(this._settings.width,10),Height:parseInt(this._settings.height,10),IsManuallyresized:d};this._isShown=true},close:function(m){if(this._isShown){this._initialized||this._initialize();this._modal.style.position="absolute";this._modal.style.visibility="hidden";this._modal.style.height="0";this._modalAnimationMask.style.position="absolute";this._modalAnimationMask.style.visibility="hidden";this._modalAnimationMask.style.height="0";this._modalMask.style.position="absolute";
this._modalMask.style.visibility="hidden";if(this._settings.url)this._modalIframe.src=this._settings.loadingHtmlUrl;var a=this._lastModalInfo.onClose;this._isShown=false;this._globalInfo=this._lastModalInfo=null;g.telligent.glow.utility.showSelectBoxes(this._modalAnimationMask);a&&u.setTimeout(function(){a(m)},9);this.dispose()}},refresh:function(){this._animationHandle&&u.clearTimeout(this._animationHandle);this.dispose();this._isShown&&this._lastModalInfo&&this.resize(this._lastModalInfo.Width,
...
this._modalMask=this._modalAnimationMask=this._modalClose=this._modalTitle=this._modal=null}this._initialized=false}}})})(jQuery,window);
(function(g,u){var z={val:function(){var f=g(this).data(x).files;return f!==null?g.map(f,function(l){return{name:l.name}}):[]}},x="_glowMultiUpload",y={begun:"glowMultiUploadBegun",complete:"glowMultiUploadComplete",error:"glowMultiUploadError"},v=function(f){return this.each(function(){var l=g(this),c=g.extend({},g.fn.glowMultiUpload.defaults,f||{},{pluploader:null,files:[],fileOffset:0,uploadedFiles:{},erroredFiles:{},cancelledFiles:{},isUploading:false,currentUploadPercent:0,fileContainer:null,
currentUploadId:0,listContainer:null,uploadButton:null});g.extend(c,{container:l,initialized:false});g(this).data(x,c);p(c)})},p=function(f){for(var l=["1234567890","0987654321","0192837465","5647382910"],c=[],b=0;b<2500;b++)c[c.length]=l[Math.floor(Math.random()*l.length)];var k=(new Date).getTime();jQuery.ajax({type:"POST",url:f.uploadUrl,data:{test:c.join("")},success:function(){var r=(new Date).getTime();n(f,f.fileList,2E5/((r-k)/1E3)*45)},error:function(){n(f,f.fileList,1E6)}})},n=function(f,
...
f.pluploader.bind("FilesAdded",function(r,e){f.addedFiles=e});f.pluploader.bind("QueueChanged",function(){m(f)});f.pluploader.bind("UploadProgress",function(r,e){if(e.status==plupload.UPLOADING){if(!f.isUploading||f.currentUploadId!=e.id){var q=!f.isUploading;f.isUploading=true;f.currentUploadId=e.id;f.currentUploadPercent=0;a(f);q&&f.container.trigger(y.begun)}f.currentUploadPercent=e.percent;a(f)}else if(e.status==plupload.FAILED){f.isUploading=false;f.erroredFiles[e.id]=true;f.currentUploadId=
null;a(f);f.container.trigger(y.error)}});f.pluploader.bind("FileUploaded",function(r,e){a:{f.uploadedFiles[e.id]=true;a(f);for(var q=0;q<f.files.length;q++)if(!f.uploadedFiles[f.files[q].id]&&!f.cancelledFiles[f.files[q].id]&&!f.erroredFiles[f.files[q].id])break a;f.isUploading=false;f.currentUploadId=null;a(f);f.uploadButton&&f.uploadButton.attr("disabled","disabled")}});f.pluploader.bind("Error",function(r,e){if(!f.initialized){var q=f.notSupportedMessage;if(!q){q=[];f.runtimes.indexOf("html5")>
-1&&q.push("An HTML5 capable browser");f.runtimes.indexOf("silverlight")>-1&&q.push('<a href="http://microsoft.com/getsilverlight/" target="_blank">Silverlight</a>');f.runtimes.indexOf("flash")>-1&&q.push('<a href="http://get.adobe.com/flashplayer/" target="_blank">Flash</a>');if(q.length==0)q="Uploading is not supported.";else{if(q.length>1)q[q.length-1]="or "+q[q.length-1];q=q.join(", ")+" is required to upload."}}f.container.children().hide();g("<div></div>").css({fontSize:"11px",borderWidth:"1px",
borderStyle:"solid",borderColor:"#999",width:f.width,overflow:"auto",overflowX:"hidden",backgroundColor:"#eee",textAlign:"center",padding:".25em",color:"#000"}).html(q).appendTo(f.container)}if(e.file){f.isUploading=false;f.erroredFiles[e.file.id]=true;f.currentUploadId=null;a(f);f.container.trigger(y.error)}});f.pluploader.bind("UploadComplete",function(r,e){j(f,e)});u.setTimeout(function(){f.pluploader.init()},9);f.container.find('input[type="file"]').hide()},m=function(f){u.clearTimeout(f.autoUploadHandle);
if(f.addedFiles){for(var l=[],c=0;c<f.pluploader.files.length;c++)for(var b=0;b<f.addedFiles.length;b++)if(f.pluploader.files[c].id==f.addedFiles[b].id){l[l.length]=f.addedFiles[b];break}f.addedFiles=null;for(b=0;b<l.length;b++)for(c=0;c<f.files.length;c++)if(f.files[c].name==l[b].name){o(f,f.files[c].id);if(f.files[c].status==plupload.QUEUED){for(var k=[],r=0;r<f.files.length;r++)if(f.files[r].id!=f.files[c].id)k[k.length]=f.files[r];f.files=k}}if(f.maxFileCount>0&&f.files.length+l.length>f.maxFileCount){for(b=
0;b<l.length;b++)o(f,l[b].id);f.container.trigger(y.error)}else{for(b=0;b<l.length;b++)f.files[f.files.length]=l[b];a(f);f.uploadButton&&f.uploadButton.removeAttr("disabled");if(l.length>0&&f.autoUpload)f.autoUploadHandle=u.setTimeout(function(){d(f)},499)}}},a=function(f){u.clearTimeout(f.fileListRefreshHandle);var l=(new Date).getTime();if(f.lastFileListRefresh>0&&l-f.lastFileListRefresh<1E3)f.fileListRefreshHandle=u.setTimeout(function(){a(f)},1001-(l-f.lastFileListRefresh));else{f.lastFileListRefresh=
l;l=[];for(var c=0;c<f.files.length;c++){l[l.length]=f.uploadedFiles[f.files[c].id]?f.uploadedFormat.replace("{0}",f.files[c].name):f.erroredFiles[f.files[c].id]?f.errorFormat.replace("{0}",f.files[c].name):f.cancelledFiles[f.files[c].id]?f.cancelledFormat.replace("{0}",f.files[c].name):f.currentUploadId==f.files[c].id?f.uploadingFormat.replace("{0}",f.files[c].name).replace("{1}",f.currentUploadPercent):f.toUploadFormat.replace("{0}",f.files[c].name).replace("{1}",f.variableName).replace("{2}",f.files[c].id);
if(c===0)l[l.length-1]=l[l.length-1].replace(f.firstItemRemove,"")}f.listContainer.html(l.join(""))}},j=function(f,l){l=g.map(l||[],function(c){return{file:c.name}});f.container.trigger(y.complete,l)},h=function(f){f.container.children(":not(.plupload)").remove();f.listContainer=g("<div></div>").css({fontSize:"11px",borderWidth:"1px",borderStyle:"solid",borderColor:"#999",borderBottomWidth:"0px",width:f.width,overflow:"auto",overflowX:"hidden",padding:".35em",backgroundColor:"#fff"});f.height&&f.height!=
"100%"?f.listContainer.css({height:f.height}):f.listContainer.css({minHeight:"50px"});f.container.append(f.listContainer);var l=g("<div></div>").css({fontSize:"11px",borderWidth:"1px",borderStyle:"solid",borderColor:"#999",width:f.width,padding:".35em",backgroundColor:"#eee",textAlign:"left"});if(f.autoUpload===false)f.uploadButton=g('<input type="button" />').val("Upload").css({cssFloat:"right"}).bind("click",function(){d(f);return false}).attr("disabled","disabled").appendTo(l);var c=g('<input type="button" />').val("Browse...").css({cssFloat:"left"}).attr("id",
f.variableName+"_browseButton").appendTo(l);g("<div></div>").css({clear:"both",height:"0px",overflow:"hidden"}).appendTo(l);f.container.append(l);a(f);f.pluploader.settings.browse_button=c.attr("id");f.pluploader.settings.drop_element=f.container.attr("id");f.initialized=true},d=function(f){f.pluploader&&u.setTimeout(function(){f.pluploader.start()},99)},o=function(f){if(f.pluploader)try{var l=f.pluploader.getFile(file_id);l&&f.pluploader.removeFile(l)}catch(c){}f.cancelledFiles[file_id]=true;a(f)};
g.fn.glowMultiUpload=function(f){if(f in z)return z[f].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof f==="object"||!f)return v.apply(this,arguments);else g.error("Method "+f+" does not exist on jQuery.fn.glowMultiUpload")};g.extend(g.fn.glowMultiUpload,{defaults:{fileFilter:null,maxFileSize:"2048mb",width:"350px",height:"200px",uploadUrl:"/",autoUpload:true,maxFileCount:5,fileList:[],swfUrl:"plupload.flash.swf",silverlightUrl:"",uploadedFormat:'<div style="overflow: hidden; text-overflow: ellipsis; color: #000; border-top: solid 1px #eee; padding-top: .25em; margin-top: .25em;"><div style="float: right; color: #3a3; margin-left: .25em;">Uploaded</div>{0}</div>',
...
k.internal.pagePosition.Height){for(var r=b-k.internal.pagePosition.Top+k.internal.itemsContainer.scrollTop,e=0;e<k.internal.itemsContainer.childNodes.length;e++)if(k.internal.itemsContainer.childNodes[e].offsetHeight<r)r-=k.internal.itemsContainer.childNodes[e].offsetHeight;else break;return e}}return-1},highlight:function(c){return this.each(function(){var b=g(this).data("orderedList");if(c){for(var k=0;k<b.internal.itemsContainer.childNodes.length;k++)b.internal.itemsContainer.childNodes[k].style.backgroundColor=
...
k.internal.backgroundColor}k.internal.selectedIndex=c;k.internal.itemsContainer.childNodes[c].style.backgroundColor="#cccccc";k.internal.itemsContainer.childNodes[c].style.borderColor="#666666";h(k,c);try{k.internal.moveItemLastIndex!=null&&f(k,k.internal.moveItemLastIndex)}catch(r){}g(k.internal.state).trigger(z.itemSelected,[k.internal.items[k.internal.selectedIndex]])}else{k.internal.itemsContainer.childNodes[k.internal.selectedIndex].style.backgroundColor=k.internal.backgroundColor;k.internal.itemsContainer.childNodes[k.internal.selectedIndex].style.borderColor=
k.internal.backgroundColor;k.internal.selectedIndex=-1}})},add:function(c){if(!c)return this;u.remove.apply(this,[c]);var b=true;return this.each(function(){if(b)b=false;else c=c._clone();var k=g(this).data("orderedList");k.internal.items[k.internal.items.length]=c;var r=document.createElement("option");r.name=c.text;r.value=c.value;k.internal.state.appendChild(r);g(k.internal.state).trigger(z.itemAdded,r)})},remove:function(c){if(!c)return this;return this.each(function(){for(var b=g(this).data("orderedList"),
k=[],r=false,e=0;e<b.internal.items.length;e++)if(b.internal.items[e].value==c.value)r=true;else k[k.length]=b.internal.items[e];for(e=0;e<b.internal.state.options.length;e++)if(b.internal.state.options[e].value==c.value){b.internal.state.removeChild(b.internal.state.options[e]);break}g(b.internal.state).trigger(z.itemRemoved,c);if(r)b.internal.items=k})},clear:function(){return this.each(function(){var c=g(this).data("orderedList");c.internal.items=[];g(c.internal.state).empty()})},insert:function(c,
b){if(!c)return this;u.remove.apply(this,[c]);return this.each(function(){var k=g(this).data("orderedList"),r=document.createElement("option");r.name=c.text;r.value=c.value;for(var e=[],q=false,t=0;t<k.internal.items.length;t++){if(t==b){q=true;e[e.length]=c;t==k.internal.items.length-1?k.internal.state.appendChild(r):k.internal.state.insertBefore(r,k.internal.state.options[t])}e[e.length]=k.internal.items[t]}if(!q){e[e.length]=c;k.internal.state.appendChild(r)}k.internal.items=e})},getByIndex:function(c){var b=
this.data("orderedList");if(b&&c>=0&&c<b.internal.items.length)return b.internal.items[c];return null},count:function(){var c=this.data("orderedList");if(c)return c.internal.items.length;return 0},createItem:function(c){return new l(c)}},z={itemSelected:"glowOrderedListItemSelected",itemRemoved:"glowOrderedListItemRemoved",itemMoved:"glowOrderedListItemMoved",itemAdded:"glowOrderedListItemAdded"},x=function(c){return this.each(function(){var b={settings:g.extend({},g.fn.glowOrderedList.defaults,c||
...
0){c.internal.itemsContainer.style.cursor="move";for(b=0;b<c.internal.itemsContainer.childNodes.length;b++)c.internal.itemsContainer.childNodes[b].style.cursor="move"}else{c.internal.itemsContainer.style.cursor="n-resize";for(b=0;b<c.internal.itemsContainer.childNodes.length;b++)c.internal.itemsContainer.childNodes[b].style.cursor="n-resize"}c.internal.draggingInitalized=true},p=function(c,b,k,r){c.internal.pagePosition==null&&u.refreshPagePosition.apply(g(c.internal.state));var e=c.internal.pagePosition.Left,
q=c.internal.pagePosition.Left+c.internal.pagePosition.Width,t=c.internal.pagePosition.Top,s=c.internal.pagePosition.Top+c.internal.pagePosition.Height;if(r){e-=24;q+=24;t-=32;s+=32;if(c.internal.moveItemLastIndex>=0){if(c.internal.moveItemLastIndex>0)t-=c.internal.itemsContainer.childNodes[c.internal.moveItemLastIndex-1].offsetHeight;if(c.internal.moveItemLastIndex<c.internal.itemsContainer.childNodes.length-1)s+=c.internal.itemsContainer.childNodes[c.internal.moveItemLastIndex+1].offsetHeight}}return b>
e&&b<q&&k>t&&k<s},n=function(c,b,k){if(!(b<0||k<0||k==b)){if(b<c.internal.items.length&&k<c.internal.items.length){var r=c.internal.items[b];if(b<k)for(var e=b;e<k;e++)c.internal.items[e]=c.internal.items[e+1];else for(e=b;e>k;e--)c.internal.items[e]=c.internal.items[e-1];c.internal.items[k]=r}if(c.internal.initialized&&b<c.internal.itemsContainer.childNodes.length&&k<c.internal.itemsContainer.childNodes.length){if(k==c.internal.itemsContainer.childNodes.length-1)c.internal.itemsContainer.appendChild(c.internal.itemsContainer.childNodes[b]);
...
0;k<c.internal.itemsContainer.childNodes.length;k++)c.internal.moveItemHeights[c.internal.moveItemHeights.length]=c.internal.itemsContainer.childNodes[k].offsetHeight;c.internal.draggingInitalized=false;g(document).bind("mouseup.orderedList",function(r){j(c,r);return false});g(document).bind("mousemove.orderedList",function(r){r=r;if(!r)r=window.event;var e=0,q=0;if(typeof r.pageY!="undefined"){e=r.pageY;q=r.pageX}else{q=g.telligent.glow.utility.getWindowInfo();e=r.clientY+q.ScrollY;q=r.clientX+q.ScrollX}var t;
if(m(c)){c.internal.draggingInitalized||v(c);if(c.internal.draggableOrderedLists.length>0&&!c.internal.moveItemIsFloating&&!p(c,q,e,true)){t=c.internal.moveItemLastIndex;if(!c.internal.moveItemFloat){c.internal.moveItemFloat=document.createElement("div");c.internal.moveItemFloat.style.position="absolute";c.internal.moveItemFloat.style.opacity=".75";if(g.telligent.glow.utility.isIE())c.internal.moveItemFloat.style.filter="progid:DXImageTransform.Microsoft.Alpha(opacity=75)";c.internal.moveItemFloat.style.backgroundColor=
...
c.internal.itemsContainer.childNodes[t].innerHTML;c.internal.moveItemIsFloating=true;c.internal.moveItemFloat.style.display="block"}if(c.internal.moveItemIsFloating){c.internal.moveItemFloat.style.left=q-c.internal.moveItemFloat.offsetWidth/2+"px";c.internal.moveItemFloat.style.top=e-c.internal.moveItemFloat.offsetHeight/2+"px";if(p(c,q,e,true)){c.internal.moveItemFloat.style.display="none";c.internal.moveItemIsFloating=false}else for(var s=0;s<c.internal.draggableOrderedLists.length;s++)if((t=c.internal.draggableOrderedLists[s].glowOrderedList("getIndexByPosition",
q,e))>=0){var w=c.internal.items[c.internal.moveItemLastIndex];j(c,r,true);u.remove.apply(g(c.internal.state),[w]);u.refresh.apply(g(c.internal.state),[]);g(c.internal.state).trigger(z.itemRemoved,w);c.internal.draggableOrderedLists[s].glowOrderedList("addDraggedItem",w,t,r);c.internal.moveItemFloat.style.display="none";c.internal.moveItemIsFloating=false}}if(m(c)&&!c.internal.moveItemIsFloating){e=e-c.internal.moveStartY;e+=c.internal.itemsContainer.scrollTop-c.internal.moveScrollStartY;r=c.internal.moveItemStartIndex;
if(e>0)for(e=e;r+1<c.internal.moveItemHeights.length&&e>c.internal.moveItemHeights[r+1];){r++;e-=c.internal.moveItemHeights[r]}else for(e=-e;r-1>=0&&e>c.internal.moveItemHeights[r-1];){r--;e-=c.internal.moveItemHeights[r]}t=r;if(t!=c.internal.moveItemLastIndex&&t!=null){n(c,c.internal.moveItemLastIndex,t);c.internal.moveItemLastIndex=t;u.select.apply(g(c.internal.state),[t,true])}}}return false})}},j=function(c,b,k){for(b=0;b<c.internal.itemsContainer.childNodes.length;b++)c.internal.itemsContainer.childNodes[b].style.cursor=
"pointer";if(!k&&c.internal.moveItemStartIndex!=null&&c.internal.moveItemLastIndex!=null&&c.internal.moveItemStartIndex!=c.internal.moveItemLastIndex){k=c.internal.items[c.internal.moveItemLastIndex];b=c.internal.moveItemStartIndex;var r=c.internal.moveItemLastIndex;g(c.internal.state).trigger(z.itemMoved,[k,b,r])}c.internal.itemsContainer.style.cursor="auto";c.internal.moveStartY=null;c.internal.moveItemLastIndex=null;c.internal.moveItemHeights=null;c.internal.moveItemStartIndex=null;g(document).unbind(".orderedList");
...
j.internal.patterns[j.internal.patterns.length-1].getRegExpPattern()+")"}c+="$";j.internal.state.is("input:disabled")?n.disabled.apply(j.internal.state,[true]):n.disabled.apply(j.internal.state,[false]);j.internal.matchRE=RegExp(c,"i");j.internal.initialized=true;n.val.apply(j.internal.state,[d])}})},z=function(a){a.internal.state.trigger("glowPatternedTextBoxChange")},x=function(a,j){for(var h=0,d=0;d<a.internal.patterns.length;d++)if(!a.internal.patterns[d].isStatic())if(h==j)return a.internal.patterns[d];
...
null;b.childNodes[k].childNodes[0].onmouseover=null;b.childNodes[k].childNodes[0].onclick=null}}}l._popupPanel.glowPopUpPanel("empty");l._currentMenuItem=null;if(!(!c||c.length==0)){b=document.createElement("table");b.cellPadding="0";b.cellSpacing="0";b.appendChild(document.createElement("tbody"));var r=false,e=false;for(k=0;k<c.length;k++){if(c[k].iconUrl)r=true;if(f.settings.expandImageUrl&&c[k]._menuItems&&c[k]._menuItems.length>0)e=true;if(r&&e)break}for(k=0;k<c.length;k++){var q=document.createElement("tr");
b.childNodes[0].appendChild(q);var t=document.createElement("td");t.className=f.settings.itemCssClass;t.id=c[k].id;t._menuItem=c[k];q.appendChild(t);var s=document.createElement("table");s.cellPadding="0";s.cellSpacing="0";s.style.width="100%";s.appendChild(document.createElement("tbody"));t.appendChild(s);q=document.createElement("tr");s.childNodes[0].appendChild(q);if(r){s=document.createElement("td");if(c[k].iconUrl){var w=document.createElement("img");w.src=c[k].iconUrl;w.style.paddingRight="4px";
if(f.settings.iconHeight)w.height=f.settings.iconHeight;if(f.settings.iconWidth)w.width=f.settings.iconWidth;s.appendChild(w)}else{s.appendChild(document.createElement("div"));s.childNodes[0].style.paddingRight="4px";if(f.settings.iconHeight)s.childNodes[0].style.height=f.settings.iconHeight+"px";if(f.settings.iconWidth)s.childNodes[0].style.width=f.settings.iconWidth+"px"}q.appendChild(s)}s=document.createElement("td");s.style.whiteSpace="nowrap";s.width="100%";s.innerHTML=c[k].text;q.appendChild(s);
if(e){s=document.createElement("td");if(f.settings.expandImageUrl&&c[k]._menuItems&&c[k]._menuItems.length>0){w=document.createElement("img");w.src=f.settings.expandImageUrl;w.style.paddingLeft="4px";if(f.settings.expandImageHeight)w.height=f.settings.expandImageHeight;if(f.settings.expandImageWidth)w.width=f.settings.expandImageWidth;s.appendChild(w)}else{s.appendChild(document.createElement("div"));s.childNodes[0].style.paddingRight="4px";if(f.settings.expandImageHeight)s.childNodes[0].style.height=
f.settings.expandImageHeight+"px";if(f.settings.expandImageWidth)s.childNodes[0].style.width=f.settings.expandImageWidth+"px"}q.appendChild(s)}t.onclick=g.telligent.glow.utility.makeBoundFunction(n,null,[f,c[k],l._level]);t.onmouseover=g.telligent.glow.utility.makeBoundFunction(m,null,[f,c[k],l._level]);c[k]._element=t}l._popupPanel.glowPopUpPanel("append",b)}},h={isOpen:function(){var f=this.data("popUpMenu");if(f)return f.internal.isOpen;return false},open:function(f,l,c,b){var k,r,e,q,t;if(typeof f===
"object"){t=f;f=g.telligent.glow.utility.getElementInfo(f);k=f.Left;r=f.Top;e=f.Width;q=f.Height}else{t=null;k=f;r=l;e=c;q=b}return this.each(function(){var s=g(this).data("popUpMenu");s.internal.initialized||a(s);s.internal.isOpen||window.setTimeout(function(){y(s)},49);s.internal.menuLevels[0]._popupPanel.glowPopUpPanel("show",k,r,e,q);s.internal.currentLevel=0;s.internal.isOpen=true;if(s.internal.openingElement=t){g(t).bind("mouseover.popUpMenu",function(){p(s)});g(t).bind("mouseout.popUpMenu",
...
0){var b,k=f.internal.menuItems,r;for(c=0;c<l.length;c++){r=false;for(b=0;k&&b<k.length;b++)if(l[c]==k[b]){m(f,k[b],c,true);k=k[b]._menuItems;r=true;break}if(!r){k&&k.length>0?h.close.apply(g(this),[c+1]):h.close.apply(g(this),[c]);break}}}}})},add:function(f){if(f){h.remove.apply(this,[f]);var l=true;return this.each(function(){var c=g(this).data("popUpMenu"),b;if(l){b=f;l=false}else b=f._clone();b._popupMenu=g(this);b._parentMenuItem=null;c.internal.menuItems[c.internal.menuItems.length]=b})}else return this},
...
u.setTimeout(function(){v(a)},999)}else{a.internal.panel.css(j,d+"px");d+=o;if(o>0&&d>h)d=h;else if(o<0&&d<h)d=h;o*=f;a.internal.animationHandle=u.setTimeout(function(){n(a,j,h,d,o,f)},19)}},m={isShown:function(){var a=this.data("_glowPopUpPanel");return a&&a.internal.isShown},isOpening:function(){var a=this.data("_glowPopUpPanel");return a&&a.internal.isOpening},show:function(a,j,h,d,o){var f,l,c,b,k,r=false;if(typeof a==="object"){d=a;if(a instanceof jQuery)d=a.get(0);a=g.telligent.glow.utility.getElementInfo(d);
f=a.Left;l=a.Top;c=a.Width;b=a.Height;k=j;r=h}else{f=a;l=j;c=h;b=d;k=o}return this.each(function(){var e=g(this).data("_glowPopUpPanel");e.internal.initialized||p(e);!e.internal.isShown&&e.settings.hideOnDocumentClick&&u.setTimeout(function(){y(e)},49);!k&&e.internal.isShown?m.hide.apply(e.internal.state):g.telligent.glow.utility.showSelectBoxes(e.internal.panelMask);var q=f,t=l;e.internal.panelMask.css({position:"absolute",zIndex:e.settings.zIndex,display:"block",visibility:"hidden",overflow:"visible"});
e.internal.panel.css({position:"absolute",display:"block",visibility:"hidden",left:"0px",top:"0px"}).addClass(e.settings.cssClass);var s=e.internal.panel.outerWidth(),w=e.internal.panel.outerHeight();r||e.internal.panelMask.css({width:s+"px",height:w+"px"});e.internal.lastWindowInfo=g.telligent.glow.utility.getWindowInfo();var A,B,C=e.settings.position.indexOf("left"),D=e.settings.position.indexOf("right"),E=e.settings.position.indexOf("up"),F=e.settings.position.indexOf("down"),G=e.settings.position.indexOf("center");
...
l>l+b-e.internal.lastWindowInfo.ScrollY||l+b-e.internal.lastWindowInfo.ScrollY<w)?e.internal.panelMask.css({top:l+"px"}):e.internal.panelMask.css({top:l+b-w+"px"})}else{if(G>-1)e.internal.panelMask.css({left:f+(c-s)/2+"px"});else!(C>-1&&D==-1)&&(D>-1&&C==-1||e.internal.lastWindowInfo.Width+e.internal.lastWindowInfo.ScrollX-f>f+c-e.internal.lastWindowInfo.ScrollX||f+c-e.internal.lastWindowInfo.ScrollX<s)?e.internal.panelMask.css({left:f+"px"}):e.internal.panelMask.css({left:f+c-s+"px"});if(!(E>-1&&
F==-1)&&(F>-1&&E==-1||e.internal.lastWindowInfo.Height+e.internal.lastWindowInfo.ScrollY-(l+b)>l-e.internal.lastWindowInfo.ScrollY||l-e.internal.lastWindowInfo.ScrollY<w)){e.internal.panelMask.css({top:l+b+"px"});A="top";B=0;s=-w}else{e.internal.panelMask.css({top:l-w+"px"});A="top";B=0;s=w}}e.internal.panel.css({visibility:"visible"});e.internal.panelMask.css({visibility:"visible",overflow:"hidden"});g.telligent.glow.utility.hideSelectBoxes(e.internal.panelMask);this._isOpening=true;if(k)e.internal.animationHandle=
u.setTimeout(function(){n(e,A,B,B,0,0)},9);else n(e,A,B,s,s>B?-((s-B)/3):(B-s)/3,0.67);if(!e.internal.isShown){e.internal.isShown=true;e.internal.lastPosition={X:q,Y:t,Width:c,Height:b};g(e.internal.state).trigger(z.shown)}})},hide:function(){return this.each(function(){var a=g(this).data("_glowPopUpPanel");if(a.internal.isShown){a.internal.initialized||p(a);a.internal.panel.css({position:"absolute",display:"none"});a.internal.panelMask.css({position:"absolute",display:"none"});a.internal.isShown=
...
a.internal.isShown&&a.internal.lastPosition&&m.show.apply(a.internal.state,[a.internal.lastPosition.X,a.internal.lastPosition.Y,a.internal.lastPosition.Width,a.internal.lastPosition.Height,true])})}};g.fn.glowPopUpPanel=function(a){if(a in m)return m[a].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof a==="object"||!a)return x.apply(this,arguments);else g.error("Method "+a+" does not exist on jQuery.fn.glowPopUpPanel")};g.extend(g.fn.glowPopUpPanel,{defaults:{cssClass:"",position:"updown",
...
document.createElement("td"),r=document.createElement("a");r.href="#";r.style.display="block";r.style.color="#000000";r.style.textDecoration="none";k.appendChild(r);var e=r;for(r=0;r<f;r++){e.appendChild(document.createElement("div"));e=e.childNodes[0]}e.innerHTML=d.internal.tabs[b].text;d.internal.tabs[b].cssClass&&g(k).addClass(d.internal.tabs[b].cssClass);o.childNodes[0].childNodes[0].appendChild(k);k._tab=d.internal.tabs[b];d.internal.tabs[b]._element=k;v(d,k.childNodes[0],d.settings.tabHoverCssClasses);
...
0;)d.internal.state.removeChild(d.internal.state.childNodes[0]);d.internal.state.className=d.settings.cssClass;l=document.createElement("div");if(d.settings.enableResizing){l.style.width="100%";l.style.overflow="hidden"}d.internal.state.appendChild(l);d.internal.tabRows=[];c=d.internal.selectedTab;d.internal.selectedTabRow=null;d.internal.selectedTab=null;r=-1;for(b=0;b<d.internal.tabs.length;b++){if(r==-1||d.settings.enableResizing&&(d.internal.tabRows[r]._tabs.length==f||d.internal.tabRows[r]._element.offsetWidth+
d.internal.tabs[b]._maxWidth>l.offsetWidth&&d.internal.tabRows[r]._tabs.length>0)){o=document.createElement("table");o.cellPadding="0";o.border="0";o.cellSpacing="0";o.appendChild(document.createElement("tbody"));o.childNodes[0].appendChild(document.createElement("tr"));l.appendChild(o);r++;d.internal.tabRows[r]=new h(o)}d.internal.tabRows[r]._element.childNodes[0].childNodes[0].appendChild(d.internal.tabs[b]._element);d.internal.tabRows[r]._tabs[d.internal.tabRows[r]._tabs.length]=d.internal.tabs[b];
d.internal.tabs[b]._tabRow=d.internal.tabRows[r];d.internal.tabs[b]._element.childNodes[0].onclick=g.telligent.glow.utility.makeBoundFunction(m,null,[d,d.internal.tabs[b],r]);d.internal.tabs[b]._element.childNodes[0].onmouseover=g.telligent.glow.utility.makeBoundFunction(p,null,[d,d.internal.tabs[b],r]);d.internal.tabs[b]._element.childNodes[0].onmouseout=g.telligent.glow.utility.makeBoundFunction(n,null,[d,d.internal.tabs[b],r]);if(d.internal.tabs[b]==c){d.internal.selectedTab=d.internal.tabs[b];
d.internal.selectedTabRow=d.internal.tabRows[r];v(d,d.internal.tabs[b]._element.childNodes[0],d.settings.tabSelectedCssClasses)}}if(d.internal.tabRows.length>1){for(b=0;b<d.internal.tabRows.length;b++)d.internal.tabRows[b]._element.style.width="100%";if(d.internal.selectedTabRow){l.removeChild(d.internal.selectedTabRow._element);l.appendChild(d.internal.selectedTabRow._element)}}d.internal.isRendered=true;if(d.internal.tabs.length>0){d.internal.resizeCheckHandle&&window.clearTimeout(d.internal.resizeCheckHandle);
...
if(o)return o.internal.selectedTab;return null}else{if(!d)return this;return this.each(function(){var f=g(this).data("tabSet"),l=u.getById.apply(g(this),[d.id]);l&&m(f,l)})}},createTab:function(d){return new j(d)}},z=function(d){return this.each(function(){var o={settings:g.extend({},g.fn.glowTabSet.defaults,d||{}),internal:{state:this,selectedTab:null,selectedTabRow:null,tabs:[],tabRows:[],resizeCheckHandle:null,isRendered:false,previousContainerOffsetWidth:-1}};g(this).data("tabSet",o);x(o,o.settings.tabs,
null);o.internal.tabs.length>0&&u.refresh.apply(g(this))})},x=function(d,o,f){if(typeof f=="undefined"&&d.internal.selectedTab)f=d.internal.selectedTab.id;d.internal.tabs=[];if(!(!o||o.length==0))for(var l=0;l<o.length;l++){d.internal.tabs[l]=new j({id:o[l][0],text:o[l][1],url:o[l][2],onClick:o[l][3],cssClass:o[l][4]});d.internal.tabs[l]._tabSet=this;if(d.internal.tabs[l].id==f)d.internal.selectedTab=d.internal.tabs[l]}},y=function(d){for(var o=0;o<d.internal.tabRows.length;o++)if(d.internal.tabRows[o]&&
...
d=0;d<h.length;d++)if(!v.elementContainsElement(p,h[d]))try{v.hideElementsInWindow(p,h[d].contentWindow,m)}catch(o){n=v.getElementInfo(h[d]);if(m||n.Top<j.Bottom&&j.Top<n.Bottom&&n.Left<j.Right&&j.Left<n.Right){if(a===null)a=y(p);x(a,h[d]);h[d].style.visibility="hidden"}}h=["object","embed","applet"];if(v.isIE())h[h.length]="select";for(d=0;d<h.length;d++)for(var f=document.getElementsByTagName(h[d]),l=0;l<f.length;l++)if(!v.elementContainsElement(p,f[l])){n=v.getElementInfo(f[l]);if(m||n.Top<j.Bottom&&
j.Top<n.Bottom&&n.Left<j.Right&&j.Left<n.Right){if(a===null)a=y(p);x(a,f[l]);f[l].style.visibility="hidden"}}},hideSelectBoxes:function(p,n){if(p instanceof jQuery)p=p.get(0);v.hideElementsInWindow(p,window.window,n)},showSelectBoxes:function(p){if(p instanceof jQuery)p=p.get(0);for(var n=null,m=0;m<z.length&&n===null;m++)if(z[m])if(z[m].Element==p)n=z[m];if(n!==null){for(m=0;m<n.HiddenSelectsIndeces.length;m++)if(p=u[n.HiddenSelectsIndeces[m]])if(p.ElementsHidingSelectsIndeces.length==1){try{if(p.SelectElement.style.visibility==
...
(function(g){g.fn.glowTransition=function(u,z){var x=g(u).hide(),y=g.extend({},g.fn.glowTransition.defaults,z||{});return this.each(function(){var v=g(this),p={width:v.outerWidth(),height:v.outerHeight(),left:v.css("left"),top:v.css("top"),position:"relative",overflow:"hidden"},n={rawWidth:x.width(),rawHeight:x.height(),width:x.outerWidth(),height:x.outerHeight()};v.wrap(g("<div></div>").css(p)).css({position:"absolute"});var m=v.parent(),a={position:"absolute"},j={},h={};if(y.resize){g.extend(a,
{width:p.width,height:p.height});g.extend(j,{width:n.width,height:n.height});g.extend(h,{width:n.rawWidth,height:n.rawHeight})}switch(y.type){case "slideLeft":a.left="+"+n.width+"px";j.left="-="+n.width;h.left=0;break;case "slideRight":a.left="-"+n.width+"px";j.left="+="+n.width;h.left=0;break;case "slideUp":a.top="+"+n.height+"px";j.top="-="+n.height;h.top=0;break;case "slideDown":a.top="-"+n.height+"px";j.top="+="+n.height;h.top=0;break;case "fade":a.opacity=0;j.opacity=0;h.opacity=1}x.prependTo(m).css(a).show();
v.stop().animate(j,y.duration);x.stop().animate(h,y.duration+1,function(){x.css({position:"static",top:"0px",left:"0px"}).unwrap();v.remove();y.complete()});m.stop().animate({width:n.width,height:n.height},y.duration)})};g.fn.glowTransition.defaults={complete:function(){},duration:200,resize:true,type:"fade"}})(jQuery);
...
nodeHeightsCache:null,movingNodeStartIndex:null,movingNodeLastIndex:null,moveStartY:null,moveScrollStartY:null,draggableTrees:[],initialized:false}};g(this).data("tree",k);n(k)})},x=function(b,k){for(var r=0;r<b.internal.nodes.length;r++)b.internal.nodes[r]._setCursor(k);b.internal.wrapper.style.cursor=k},y=function(b,k,r,e){b.internal.pagePosition==null&&d(b);var q=b.internal.pagePosition.Left,t=b.internal.pagePosition.Left+b.internal.pagePosition.Width,s=b.internal.pagePosition.Top;b=b.internal.pagePosition.Top+
b.internal.pagePosition.Height;if(e){q-=10;t+=10;s-=10;b+=10}return k>q&&k<t&&r>s&&r<b},v=function(b,k){return k.expanded()&&k.count()>0?k._element.offsetHeight-k._element.childNodes[2].offsetHeight:k._element.offsetHeight},p=function(b,k,r){for(var e=0;e<k.length;e++)if(k[e]._element)if(k[e]===r){var q={};q.parentNode=k[e]._parent;q.height=k[e]._element.offsetHeight;q.index=e;b.internal.nodeHeightsCache[b.internal.nodeHeightsCache.length]=q;b.internal.movingNodeStartIndex=b.internal.nodeHeightsCache.length-
1;b.internal.movingNodeLastIndex=b.internal.nodeHeightsCache.length-1}else{q={};q.parentNode=k[e]._parent;q.height=v(b,k[e]);q.index=e;q.isBeforeNode=k[e]._parent==r._parent;b.internal.nodeHeightsCache[b.internal.nodeHeightsCache.length]=q;var t=q.height*0.25;if(k[e].expanded())if(k[e]._nodes.length>0)p(b,k[e]._nodes,r);else if(k[e].canHaveChildren()){q.height-=t;var s={};s.parentNode=k[e];s.height=t;s.index=0;b.internal.nodeHeightsCache[b.internal.nodeHeightsCache.length]=s}s=null;if(k[e]._parent==
r._parent){s={};s.parentNode=k[e]._parent;s.height=q.height;s.index=e;s.isAfterNode=true;b.internal.nodeHeightsCache[b.internal.nodeHeightsCache.length]=s}if(e==k.length-1){q.height-=t;if(s)s.height=q.height;q={};q.parentNode=k[e]._parent;q.height=t;q.index=e+1;b.internal.nodeHeightsCache[b.internal.nodeHeightsCache.length]=q}}},n=function(b){if(b.internal.state.offsetHeight){if(b.internal.state.disabled){b.internal.state.disabled=false;b.internal.state.readonly=true}b.internal.backgroundColor=g.telligent.glow.utility.getCurrentStyleValue(b.internal.state,
...
b.internal.state);m(b,null,b.internal.state.options,0,b.settings.nodeHtml,0);b.internal.state.style.display="none";b.internal.initialized=true;l.disabled.apply(g(b.internal.state),[b.internal.state.readonly===true]);if(b.internal.state.selectedIndex>=0){var k=l.getByValue.apply(g(b.internal.state),[b.internal.state.options[b.internal.state.selectedIndex].value]);k&&l.selected.apply(g(b.internal.state),[k])}}else window.setTimeout(function(){n(b)},249)},m=function(b,k,r,e,q,t){var s,w,A,B;for(w=e;w<
r.length;w++){var C=r[w].text;if(B=C.match(/^(\-*) /)){A=B[1].length/2;C=C.substr(B[1].length)}else A=0;if(A==t){A=r[w].value;(s=q.shift())||(s=C);s=new c({html:s,value:A});if(k)k.add(s);else{s._parent=null;s._treeContext=b;b.internal.nodes[b.internal.nodes.length]=s}}else if(A>t&&s)w+=m(b,s,r,w,q,t+1);else return w-e-1}return r.length-e-1},a=function(b,k,r){var e,q;if(r){q=k._element;r=q.offsetTop;e=v(b,k);k=q.offsetLeft}else{q=k._element.childNodes[1];r=q.offsetTop;e=v(b,k);k=q.offsetLeft-k._element.childNodes[0].offsetWidth}r-=
6;k-=6;for(var t=q.offsetParent;t&&t!=b.internal.wrapper;){r+=t.offsetTop;k+=t.offsetLeft;t=t.offsetParent}t=b.internal.wrapper.offsetWidth-24;if(k+q.offsetWidth>b.internal.wrapper.scrollLeft+t&&q.offsetWidth<t)b.internal.wrapper.scrollLeft=k;else if(k<b.internal.wrapper.scrollLeft||k+q.offsetWidth>b.internal.wrapper.scrollLeft+t)b.internal.wrapper.scrollLeft=k;q=b.internal.wrapper.offsetHeight-24;if(r+e>b.internal.wrapper.scrollTop+q&&e<q)b.internal.wrapper.scrollTop=r+e-q;else if(r<b.internal.wrapper.scrollTop||
r+e>b.internal.wrapper.scrollTop+q)b.internal.wrapper.scrollTop=r},j=function(b){b.internal.draggableTrees=[];b.settings.draggableTrees&&b.settings.draggableTrees.each(function(){try{if(g(this).glowTree("disabled")===false)b.internal.draggableTrees[b.internal.draggableTrees.length]=g(this)}catch(k){}})},h=function(b){d(b);j(b);var k;for(k=0;k<b.internal.draggableTrees.length;k++)b.internal.draggableTrees[k].glowTree("highlight",true);b.internal.draggableTrees.length>0?x(b,"move"):x(b,"n-resize");
b.internal.draggingInitalized=true},d=function(b){b.internal.pagePosition=g.telligent.glow.utility.getElementInfo(b.internal.wrapper)},o=function(b,k,r){if(!k)k=window.event;if(b.internal.movingNode==null){b.internal.movingNode=r;b.internal.movingNodeStartParent=r.getParent();b.internal.draggingInitalized=false;if(typeof k.pageY!="undefined")b.internal.moveStartY=k.pageY;else{var e=g.telligent.glow.utility.getWindowInfo();b.internal.moveStartY=k.clientY+e.ScrollY}b.internal.moveScrollStartY=b.internal.wrapper.scrollTop;
b.internal.nodeHeightsCache=[];b.internal.wrapper.style.overflow="hidden";p(b,b.internal.nodes,r);g(document).bind("mouseup.glowTree",function(q){f(b,q);return false}).bind("mousemove.glowTree",function(q){q=q;if(!q)q=window.event;var t=0,s=0;if(typeof q.pageY!="undefined"){t=q.pageY;s=q.pageX}else{s=g.telligent.glow.utility.getWindowInfo();t=q.clientY+s.ScrollY;s=q.clientX+s.ScrollX}if(b.internal.movingNode!=null){b.internal.draggingInitalized||h(b);var w=t-b.internal.moveStartY;w+=b.internal.wrapper.scrollTop-
b.internal.moveScrollStartY;var A=b.internal.movingNodeStartIndex,B=w;w={};w.parentNode=null;w.index=-1;w.nodeHeightsCacheIndex=A;if(b.internal.nodeHeightsCache&&A>=0&&A<b.internal.nodeHeightsCache.length){A=A;for(var C=B>0,D=false;!D;)if(B>0)if(A<b.internal.nodeHeightsCache.length-1&&(B>b.internal.nodeHeightsCache[A+1].height||b.internal.nodeHeightsCache[A+1].isBeforeNode)){A++;b.internal.nodeHeightsCache[A].isBeforeNode||(B-=b.internal.nodeHeightsCache[A].height)}else D=true;else if(B<0)if(A>0&&
(-B>b.internal.nodeHeightsCache[A-1].height||b.internal.nodeHeightsCache[A-1].isAfterNode)){A--;b.internal.nodeHeightsCache[A].isAfterNode||(B+=b.internal.nodeHeightsCache[A].height)}else D=true;else D=true;if(C)for(;b.internal.nodeHeightsCache[A].isBeforeNode&&A>0;)A--;else for(;b.internal.nodeHeightsCache[A].isAfterNode&&A<b.internal.nodeHeightsCache.length-1;)A++;w.parentNode=b.internal.nodeHeightsCache[A].parentNode;w.index=b.internal.nodeHeightsCache[A].index;w.nodeHeightsCacheIndex=A}if(b.internal.draggableTrees.length>
...
"block"}if(b.internal.movingNodeIsFloating){b.internal.movingNodeFloat.style.left=s-b.internal.movingNodeFloat.offsetWidth/2+"px";b.internal.movingNodeFloat.style.top=t-b.internal.movingNodeFloat.offsetHeight/2+"px";if(y(b,s,t,true)){b.internal.movingNodeFloat.style.display="none";b.internal.movingNodeIsFloating=false}else{B=null;for(A=0;A<b.internal.draggableTrees.length;A++)if((B=b.internal.draggableTrees[A].glowTree("getParentAndIndex",s,t)).index!=-1){C=b.internal.movingNode;f(b,q,true);l.remove.apply(g(b.internal.state),
[C]);l.refresh.apply(g(b.internal.state),[]);g(b.internal.state).trigger(u.nodeRemoved,[C]);b.internal.draggableTrees[A].glowTree("addDraggedNode",C,B.parentNode,B.index,q);b.internal.movingNodeFloat.style.display="none";b.internal.movingNodeIsFloating=false}}}if(b.internal.movingNode!=null&&!b.internal.movingNodeIsFloating&&w.nodeHeightsCacheIndex!=b.internal.movingNodeLastIndex){b.internal.movingNodeLastIndex=w.nodeHeightsCacheIndex;t=b.internal.movingNode._parent;w.parentNode?w.parentNode.insert(b.internal.movingNode,
w.index):l.insert.apply(g(b.internal.state),[b.internal.movingNode,w.index]);b:{s=w.parentNode;q=[];for(t=t;t;){q[q.length]=t;t=t._parent}for(t=s;t;){for(s=q.length-1;s>=0;s--)if(q[s]==t){q=t;break b}t=t._parent}q=null}q?q.refresh():l.refresh.apply(g(b.internal.state),[]);l.selected.apply(g(b.internal.state),[b.internal.movingNode])}}return false})}},f=function(b,k,r){x(b,"default");!r&&b.internal.movingNode&&b.internal.movingNodeStartIndex!=b.internal.movingNodeLastIndex&&g(b.internal.state).trigger(u.nodeMoved,
...
l={getParentAndIndex:function(b,k){var r=g(this).data("tree");if(!r)return null;r.internal.pagePosition==null&&d(r);var e={};e.parentNode=null;e.index=-1;if(b>r.internal.pagePosition.Left&&b<r.internal.pagePosition.Left+r.internal.pagePosition.Width&&k>r.internal.pagePosition.Top-10&&k<r.internal.pagePosition.Top+r.internal.pagePosition.Height+10){k-=r.internal.pagePosition.Top;k-=r.internal.container.offsetTop;k+=r.internal.wrapper.scrollTop;for(var q=e.index=0;q<r.internal.nodes.length;q++)if(r.internal.nodes[q]._element)if(k<
r.internal.nodes[q]._element.offsetHeight){if(r=r.internal.nodes[q]._getParentAndIndex(k))if(r.moveNext)e.index++;else e=r;break}else{k-=r.internal.nodes[q]._element.offsetHeight;e.index++}}return e},highlight:function(b){return this.each(function(){var k=g(this).data("tree");if(b){for(var r=0;r<k.internal.nodes.length;r++)k.internal.nodes[r]._highlight();k.internal.wrapper.style.backgroundColor="#cccccc";k.internal.wrapper.style.borderColor="#666666";d(k)}else{for(r=0;r<k.internal.nodes.length;r++)k.internal.nodes[r]._unhighlight();
k.internal.wrapper.style.backgroundColor=k.internal.backgroundColor;k.internal.wrapper.style.borderColor="#999999"}})},addDraggedNode:function(b,k,r,e){var q=this.data("tree");if(q){if(!e)e=window.event;if(k){k.insert(b,r);k.refresh()}else{l.insert.apply(g(q.internal.state),[b,r]);l.refresh.apply(g(q.internal.state),[])}g(q.internal.state).trigger(u.nodeAdded,[b]);l.selected.apply(g(q.internal.state),[b]);o(q,e,b);h(q)}return this},selected:function(b){if(b===undefined){var k=this.data("tree");if(k)return k.internal.selectedNode}else return this.each(function(){var r=
g(this).data("tree"),e=l.getByValue.apply(g(this),[b.value]);if(e){var q=r.internal.selectedNode;if(r.internal.selectedNode&&r.internal.selectedNode._element)r.internal.selectedNode._element.childNodes[1].style.backgroundColor=r.internal.backgroundColor;if(e._element){e._element.childNodes[1].style.backgroundColor="#ccc";r.internal.selectedNode=e;a(r,e);q!=e&&g(r.internal.state).trigger(u.nodeSelected,[r.internal.selectedNode])}else r.internal.selectedNode=null}})},resize:function(b,k){if(b<=4)b=
4;if(k<=4)k=4;return this.each(function(){var r=g(this).data("tree");r.internal.wrapper.style.width=b-4+"px";r.internal.wrapper.style.height=k-4+"px"})},disabled:function(b){if(b===undefined){var k=this.data("tree");if(k)return k.internal.state.readonly}else return this.each(function(){var r=g(this).data("tree");r.internal.state.readonly=b;l.refresh.apply(g(r.internal.state),[])})},refresh:function(){return this.each(function(){var b=g(this).data("tree");if(b.internal.initialized){for(;b.internal.container.childNodes.length>
0;)b.internal.container.removeChild(b.internal.container.childNodes[0]);for(var k=0;k<b.internal.nodes.length;k++){b.internal.nodes[k]._dispose(true);b.internal.nodes[k].refresh()}b.internal.selectedNode&&l.selected.apply(g(b.internal.state),[b.internal.selectedNode])}})},add:function(b){if(!b)return this;l.remove.apply(this,[b]);var k=true;return this.each(function(){if(k)k=false;else b=b._clone();var r=g(this).data("tree");b._parent=null;b._treeContext=r;r.internal.nodes[r.internal.nodes.length]=
b})},remove:function(b){if(b)return this.each(function(){var k=g(this).data("tree"),r=l.getByValue.apply(g(k.internal.state),[b.value]);if(r)if(r.getParent()==null){for(var e=[],q=false,t=0;t<k.internal.nodes.length;t++)if(k.internal.nodes[t]==r)q=true;else e[e.length]=k.internal.nodes[t];if(q){r._dispose();k.internal.nodes=e}}else r.getParent()._remove(r)})},insert:function(b,k){if(!b)return this;l.remove.apply(this,[b]);var r=true;return this.each(function(){if(r)r=false;else b=b._clone();var e=
g(this).data("tree");if(k<0||k>=e.internal.nodes.length)k=e.internal.nodes.length;for(var q=e.internal.nodes.length;q>k;q--)e.internal.nodes[q]=e.internal.nodes[q-1];b._parent=null;b._treeContext=e;e.internal.nodes[k]=b})},getByValue:function(b){var k=this.data("tree");if(k)for(var r,e=0;e<k.internal.nodes.length;e++)if(k.internal.nodes[e].value==b)return k.internal.nodes[e];else if((r=k.internal.nodes[e].getByValue(b))!=null)return r;return null},getIndex:function(b){var k=this.data("tree");if(k){for(var r=
0;r<k.internal.nodes.length;r++)if(k.internal.nodes[r]==b)return r;return-1}},getByIndex:function(b){var k=this.data("tree");if(k&&b<k.internal.nodes.length&&b>=0)return k.internal.nodes[b]},count:function(){var b=this.data("tree");if(b)return b.internal.nodes.length},createTreeNode:function(b){return new c(b)}};g.fn.glowTree=function(b){if(b in l)return l[b].apply(this,Array.prototype.slice.call(arguments,1));else if(typeof b==="object"||!b)return z.apply(this,arguments);else g.error("Method "+b+
...
this._treeContext.settings.collapsedImageUrl;if(l.disabled.apply(g(this._treeContext.internal.state)))b.childNodes[0].style.cursor="default";else{b.childNodes[0].style.cursor="pointer";var w=this;b.childNodes[0].onclick=function(){w.expanded(!w._isExpanded,true)}}if(this._isExpanded){k=document.createElement("ul");k.style.listStyleType="none";k.style.margin="0";k.style.padding="0";k.style.paddingLeft="16px";b.appendChild(k);for(k=0;k<this._nodes.length;k++){this._nodes[k]._dispose(true);this._nodes[k]._parent=
...
[b]);b._parent=this;b._treeContext=this._treeContext;this._nodes[this._nodes.length]=b};c.prototype._remove=function(b){for(var k=[],r=false,e=0;e<this._nodes.length;e++)if(this._nodes[e].value==b.value)r=true;else k[k.length]=this._nodes[e];if(r){b._dispose();this._nodes=k}};c.prototype.canHaveChildren=function(b){if(b===undefined)return this._treeContext&&this._treeContext.settings.canHaveChildren?this._treeContext.settings.canHaveChildrenFunction(g(this._treeContext.internal.state),this):this._canHaveChildren;
else this._canHaveChildren=b===true};c.prototype.insert=function(b,k){if(k>=0){l.remove.apply(g(this._treeContext.internal.state),[b]);if(k>this._nodes.length)k=this._nodes.length;for(var r=this._nodes.length;r>k;r--)this._nodes[r]=this._nodes[r-1];this._nodes[k]=b;b._parent=this;b._treeContext=this._treeContext}};c.prototype.getByValue=function(b){for(var k,r=0;r<this._nodes.length;r++)if(this._nodes[r].value==b)return this._nodes[r];else if((k=this._nodes[r].getByValue(b))!=null)return k;return null};
